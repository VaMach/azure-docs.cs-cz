...
**Účty úložiště**: Pro každou oblast, ve které jsou spuštěné virtuální počítače, je určený účet úložiště. To umožňuje ukládání dat v oblasti, kde se nachází virtuální počítač, ze kterého data jsou shromažďována. Tato data, včetně souborů se stavem systému, budou trvale uložena v účtu úložiště. Snímky disků virtuálních počítačů se ukládají ve stejném účtu úložiště jako disk virtuálního počítače.
