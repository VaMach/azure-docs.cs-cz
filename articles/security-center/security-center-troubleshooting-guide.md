<properties
   pageTitle="Průvodce odstraňováním potíží se službou Azure Security Center | Microsoft Azure"
...
> [AZURE.NOTE] Pokud se agent služby Azure Security Center nechová podle očekávání, je třeba restartovat cílový virtuální počítač, protože pro zastavení a spuštění agenta není k dispozici žádný příkaz.
