<properties
   pageTitle="Výstrahy zabezpečení podle typu ve službě Azure Security Center | Microsoft Azure"
...
# Výstrahy zabezpečení podle typu ve službě Azure Security Center
