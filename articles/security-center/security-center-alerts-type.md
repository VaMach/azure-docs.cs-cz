...
# Principy výstrah zabezpečení ve službě Azure Security Center
...
## Jaké typy výstrah jsou k dispozici?
...
## Analýza chování virtuálního počítače
...
### Dotazování více doménových účtů
...
### Výpis členů místní skupiny Administrators
...
### Neobvyklá kombinace velkých a malých písmen
...
### Podezření na útok Kerberos Golden Ticket
...
### Vytvoření podezřelého pravidla brány firewall
...
### Podezřelá kombinace HTA a PowerShellu
...
### Zranitelnost vůči útoku prostřednictvím injektáže SQL
...
### Neobvyklý přístup z neznámého umístění
