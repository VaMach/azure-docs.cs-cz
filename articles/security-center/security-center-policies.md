<properties
   pageTitle="Nastavení zásad zabezpečení ve službě Azure Security Center | Microsoft Azure"
...
3. Otevře se okno **Zásady zabezpečení** pro dané předplatné, které obsahuje podobné možnosti jako následující snímek obrazovky:
    ...
    - **Cenová úroveň**: Tuto možnost použijte pro upgrade výběru cenové úrovně. Další informace o možnostech cen najdete na [stránce služby Security Center](https://azure.microsoft.com/pricing/details/security-center/).
