<properties
   pageTitle="Využití Azure Security Center při reakci na incidenty | Microsoft Azure"
...
1. Kliknutím na dlaždici **Výstrahy zabezpečení** otevřete okno **Výstrahy zabezpečení**.
    ...
    > [AZURE.NOTE] Pro účely tohoto scénáře provede Judy vyhodnocení výstrahy Škodlivá aktivita SQL, jak je znázorněno na obrázku výše. 
