...
## <a name="install-the-necessary-java-artifacts-on-vagrant-optional-if-you-want-to-use-the-java-programming-models"></a>Instalace potřebných artefaktů Java na Vagrant (volitelné, pokud chcete použít programovací modely jazyka Java)
