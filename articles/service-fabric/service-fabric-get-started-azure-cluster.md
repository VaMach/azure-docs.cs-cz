...
Pro připojení k uzlům v clusteru s Linuxem můžete použít SSH, pokud zadáte číslo portu 3389 nebo vyšší. Například pro cluster s pěti uzly vytvořený dříve by příkazy vypadaly následovně:
```bash
