---
title: Vytvoření první aplikace Service Fabric v sadě Visual Studio | Microsoft Docs
...
1. Stisknutím klávesy F5 ve Visual Studiu aplikaci nasadíte pro ladění.
   ...
   > [!NOTE]
   > Nasazení bude napoprvé chvíli trvat, protože Visual Studio vytváří místní cluster pro vývoj. Místní cluster spouští na jednom počítači stejný kód platformy, na kterém později budete stavět v clusteru s více počítači. V okně výstupu sady Visual Studio se zobrazí stav vytváření clusteru.
   > 
   > 
