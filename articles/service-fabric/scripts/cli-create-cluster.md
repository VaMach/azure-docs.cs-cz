...
| Příkaz | Poznámky |
|---|---|
| [Vytvoření clusteru sf az](https://docs.microsoft.com/en-us/cli/azure/sf/cluster?view=azure-cli-latest#az_sf_cluster_create) | Vytvoří nový cluster Service Fabric.  |
