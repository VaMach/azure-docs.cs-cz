...
V tomto kurzu je součástí dvě řady a ukazuje, jak můžete škálovat vaše existující cluster v a. Po dokončení, budete vědět, jak škálování clusteru a jak vyčistit všechny prostředky, zbývá.
