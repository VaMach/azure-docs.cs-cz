...
You can also use the [IncludeTotalCount](http://msdn.microsoft.com/zh-cn/library/windowsazure/jj730933.aspx) method to ensure that the query will get the total count for <i>all</i> the records that would have been returned, ignoring any take paging/limit clause specified:
...
<!-- URLs. -->
[Get started with Mobile Services iOS]: /zh-cn/develop/mobile/tutorials/get-started-xamarin-ios
[Get started with Mobile Services Android]: /zh-cn/develop/mobile/tutorials/get-started-xamarin-android
[Xamarin download]: http://xamarin.com/download/
[Mobile Services SDK]: http://go.microsoft.com/fwlink/?LinkId=257545
[Xamarin.iOS quickstart tutorial]: /zh-cn/develop/mobile/tutorials/get-started-xamarin-ios/
[Xamarin.Android quickstart tutorial]: /zh-cn/develop/mobile/tutorials/get-started-xamarin-android/
[Xamarin.iOS data tutorial]: /zh-cn/develop/mobile/tutorials/get-started-with-data-xamarin-ios/
[Xamarin.Android data tutorial]: /zh-cn/develop/mobile/tutorials/get-started-with-data-xamarin-android/
[Xamarin.iOS authentication]: /zh-cn/develop/mobile/tutorials/get-started-with-users-xamarin-ios/
[Xamarin.Android authentication]: /zh-cn/develop/mobile/tutorials/get-started-with-users-xamarin-android/
[Mobile Services SDK]: http://go.microsoft.com/fwlink/?LinkId=257545
...
[Get started with data iOS]: /zh-cn/develop/mobile/tutorials/get-started-with-data-xamarin-ios
[Get started with data Android]: /zh-cn/develop/mobile/tutorials/get-started-with-data-xamarin-android
[Get started with authentication iOS]: /zh-cn/develop/mobile/tutorials/get-started-with-users-xamarin-ios
[Get started with authentication Android]: /zh-cn/develop/mobile/tutorials/get-started-with-users-xamarin-android
[Validate and modify data with scripts ios]: /zh-cn/develop/mobile/tutorials/validate-modify-and-augment-data-xamarin-ios
[Validate and modify data with scripts android]: /zh-cn/develop/mobile/tutorials/validate-modify-and-augment-data-xamarin-android
[Refine queries with paging iOS]: /zh-cn/develop/mobile/tutorials/add-paging-to-data-xamarin-ios
[Refine queries with paging Android]: /zh-cn/develop/mobile/tutorials/add-paging-to-data-xamarin-android
[Authorize users with scripts iOS]: /zh-cn/develop/mobile/tutorials/authorize-users-in-scripts-xamarin-ios
[Authorize users with scripts Android]: /zh-cn/develop/mobile/tutorials/authorize-users-in-scripts-xamarin-android
