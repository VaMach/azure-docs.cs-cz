...
* Cluster Azure HDInsight: Chcete-li ho vytvořit, přečtěte si o [začátku používání HDInsightu s Linuxem](apache-hadoop-linux-tutorial-get-started.md).
