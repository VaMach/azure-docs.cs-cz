...
1. K načtení Zookeeper kvora pro váš cluster HBase, použijte jednu z následujících příkladech:
    ...
    >
    > Tento příklad vyžaduje prostředí Azure PowerShell. Další informace o použití prostředí Azure PowerShell najdete v tématu [Začínáme s Azure PowerShell](https://docs.microsoft.com/powershell/scripting/Getting-Started-with-Windows-PowerShell?view=powershell-6)
