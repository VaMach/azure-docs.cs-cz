...
> [!NOTE]
> Postup v tomto článku předpokládá, že používáte klienta se systémem Windows. Pokud používáte klienta OS X, Linux a Unix, naleznete postup v části [Použití SSH se systémem Linux Hadoop v HDInsight z OS X, Linux a Unix](hdinsight-hadoop-linux-use-ssh-unix.md).
> 
