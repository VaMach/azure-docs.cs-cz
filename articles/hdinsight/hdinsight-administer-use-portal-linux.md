...
* HBase
    ...
    Další informace o používání prostředí HBase naleznete v části [začít pracovat s příklad Apache HBase v HDInsight](hdinsight-hbase-tutorial-get-started-linux.md).
