...
Funkce monitorování koncového bodu služby v [sledování výkonu sítě](log-analytics-network-performance-monitor.md) vám umožní monitorovat připojení k síti pro libovolný koncový bod, který má otevřený port TCP. Tyto koncové body můžou být webů, aplikací SaaS, PaaS aplikací a databází SQL. 
