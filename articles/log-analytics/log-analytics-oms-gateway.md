...
| 106 |Z jakéhokoli důvodu, který je relace protokolu TLS podezřelé a odmítnutých |
...
* [Přidat zdroje dat](log-analytics-data-sources.md) pro shromažďování dat z připojené zdroje v pracovním prostoru OMS a uložte ho do úložiště OMS.
