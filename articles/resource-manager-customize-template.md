---
title: Přizpůsobení vyexportované šablony Resource Manageru | Microsoft Docs
...
1. Pokud chcete šablonu nasadit pomocí vlastního skriptu, použijte jednu z následujících možností.
...
2. Pokud jste si stáhli vyexportovanou šablonu a skripty, najděte soubor **deploy.ps1** (pokud používáte PowerShell) nebo soubor **deploy.sh** (pokud používáte Azure CLI).
