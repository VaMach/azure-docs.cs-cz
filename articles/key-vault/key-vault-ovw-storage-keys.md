...
Zajistěte, aby byla vaše oprávnění úložišť nastavená na *všechny*. Můžete získat yourKeyVaultServicePrincipalId a nastavit oprávnění pro úložiště pomocí následujících příkazů.
