...
Pokud účet úložiště používá model nasazení Classic, můžete disk virtuálního počítače odebrat pomocí následujících kroků na portálu [Azure Portal](https://manage.windowsazure.com):
