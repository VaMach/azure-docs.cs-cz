...
Ukázkový kód vytvoří místní soubor má být použit pro nahrávání a stahování, uložení souboru k odeslání jako **zdroj** a název objektu blob v **blob**. Následující příklad odešle soubor do kontejneru s názvem **quickstartblobs**.
