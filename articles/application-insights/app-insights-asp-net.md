---
title: Nastavení analýzy webových aplikací pro ASP.NET pomocí Application Insights | Microsoft Docs
...
| **[Přidat další data](app-insights-asp-net-more.md)**<br/>Sledování využití, dostupnosti, závislostí, výjimek. Integrujte trasování z rozhraní protokolování. Zapisuje vlastní telemetrii. |
