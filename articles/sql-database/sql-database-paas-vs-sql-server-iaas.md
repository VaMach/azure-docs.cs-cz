---
title: SQL (PaaS) Database vs. SQL Server v cloudu na virtuálních počítačích (IaaS) | Microsoft Docs
...
|  | | |
| **Prostředky:** |Nechcete využívat prostředky IT ke konfiguraci a správě základní infrastruktury, ale chcete se soustředit na aplikační vrstvu. |Máte některé prostředky IT ke konfiguraci a správě. Některé poskytované automatizované funkce to značně zjednodušují. |
...
**SQL Database** je zákazníkům prodávána jako služba, nikoli s licencí.  [SQL Server na virtuálních počítačích Azure](../virtual-machines/virtual-machines-windows-sql-server-iaas-overview.md) je prodáván se zahrnutou licencí, za kterou platíte po minutách. Máte-li stávající licenci, můžete ji také použít.  
