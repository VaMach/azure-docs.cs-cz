...
# <a name="get-started-with-azure-sql-database-servers-databases-and-firewall-rules-by-using-azure-powershell"></a>Začínáme se servery, databázemi a pravidly brány firewall služby Azure SQL Database pomocí prostředí Azure PowerShell
