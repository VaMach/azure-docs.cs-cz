...
### Izolované databáze
#### Informace
##### [Kurz Azure Portal: Archivace databáze SQL Azure s použitím portálu Azure Portal](sql-database-get-started.md)
#### Správný postup
##### [Kurz Azure Portal: Archivace databáze SQL Azure s použitím portálu Azure Portal](sql-database-get-started.md)
##### [Kurz Azure Portal: Archivace databáze SQL Azure s použitím PowerShellu](sql-database-get-started-powershell.md)
##### [Kurz Azure Portal: Vytvoření databáze SQL Azure s použitím C#](sql-database-get-started-csharp.md)
...
#### Informace
##### [Horizontální navýšení kapacity](sql-database-elastic-scale-introduction.md)
...
##### [Odinstalace elastických úloh](sql-database-elastic-jobs-uninstall.md)
...
##### [Průvodce migrací sady SQL Server Management Studio](sql-database-cloud-migrate-compatible-using-ssms-migration-wizard.md)
#### Kopírování databáze
...
### Správný postup
### [Kurz: Přístup a ověřování SQL](sql-database-get-started-security.md)
...
##### [Úložiště certifikátů systému Windows](sql-database-always-encrypted.md)
...
#### Převzetí služeb při selhání pomocí aktivní geografické replikace
...
### Zákaznické implementace softwaru jako služby
...
### Úlohy a automatizace
#### [Instalace služby](sql-database-elastic-jobs-service-installation.md)
#### [Vytváření a správa elastických úloh na webu Azure Portal](sql-database-elastic-jobs-create-and-manage.md)
...
#### [Pomocí webu Azure Portal](sql-database-scale-up.md)
#### [Pomocí PowerShellu](sql-database-scale-up-powershell.md)
