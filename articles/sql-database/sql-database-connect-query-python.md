...
- Máte nainstalovaný Python a související software pro váš operační systém.
    ...
    - **Ubuntu:** Nainstalujte Python a další požadované balíčky a potom nainstalujte ovladač Python pro SQL Server. Viz [kroky 1.2 a 2.1](https://www.microsoft.com/sql-server/developer-get-started/node/ubuntu/).
    - **Windows:** Nainstalujte nejnovější verzi Pythonu (proměnnou prostředí teď už máte nakonfigurovanou), nainstalujte ovladač ODBC a nástroj SQLCMD a potom nainstalujte ovladač Python pro SQL Server. Viz [kroky 1.2, 1.3 a 2.1](https://www.microsoft.com/sql-server/developer-get-started/node/windows/). 
