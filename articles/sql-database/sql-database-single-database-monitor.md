...
## Monitorování databází pomocí zobrazení dynamické správy
...
>[AZURE.NOTE] **Sys.dm_db_resource_stats** vrací prázdný výsledek při použití pro databáze s úrovněmi Web a Business, které jsou již ukončené.
