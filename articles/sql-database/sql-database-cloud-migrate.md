...
5. [Export](sql-database-export.md) kopie databáze do souboru .BACPAC na místní jednotce.
6. [Import](sql-database-import.md) souboru .BACPAC jako nové databáze SQL Azure pomocí kteréhokoli z mnoha nástrojů pro import souborů BACPAC. Doporučeným nástrojem pro zajištění nejlepšího výkonu je SQLPackage.exe.
