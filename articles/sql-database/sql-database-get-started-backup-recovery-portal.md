---
title: "Azure Portal: Zálohování a obnovení – Azure SQL Database | Dokumentace Microsoftu"
...
---
# <a name="tutorial-back-up-and-restore-an-azure-sql-database-using-the-azure-portal"></a>Kurz: Zálohování a obnovení Azure SQL Database pomocí webu Azure Portal
...
> [!TIP]
> Pokud chcete odstranit zálohy v dlouhodobém uchovávání záloh, přečtěte si téma [Správa dlouhodobého uchovávání záloh pomocí PowerShellu](sql-database-manage-long-term-backup-retention-powershell.md).
>
