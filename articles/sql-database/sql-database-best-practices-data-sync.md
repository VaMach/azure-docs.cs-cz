...
-   Změnit pověření pro různé fáze (například *credential1* pro instalační program a *credential2* pro probíhající).
...
Ne všechny tabulky v databázi musí být ve skupině pro synchronizaci. Výběr tabulky, které pokud chcete zahrnout do skupiny synchronizace a které chcete vyloučit (nebo zahrnout do jiné skupiny synchronizace) může ovlivnit efektivitu a nákladů. Zahrnete pouze ty tabulky do skupiny synchronizace, že obchodní potřeby vyžádání a tabulky, na kterých jsou závislé.
