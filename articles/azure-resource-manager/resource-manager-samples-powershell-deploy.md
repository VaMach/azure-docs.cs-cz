...
| Příkaz | Poznámky |
|---|---|
| [Registrace AzureRmResourceProvider](/powershell/module/azurerm.resources/register-azurermresourceprovider) | Zaregistruje poskytovatele prostředků, aby jeho typy prostředků můžete nasadit na vaše předplatné.  |
