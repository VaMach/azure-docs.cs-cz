...
| Parametry |Ne |Hodnoty, které jsou k dispozici při nasazení pro přizpůsobení nasazení prostředků. |
...
| Popis |Ne |Popis parametru, který se zobrazí uživatelům prostřednictvím portálu. |
