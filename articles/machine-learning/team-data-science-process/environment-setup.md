...
* Pokyny na otázky, které vzít v úvahu při tomto rozhodnutí najdete v tématu [plánování vašeho Azure Machine Learning Data vědecké účely prostředí](plan-your-environment.md). 
* Katalog některého z následujících scénářů se můžete setkat při provádění pokročilou analýzu, najdete v části [scénáře pro proces Team Data vědecké účely](plan-sample-scenarios.md)
