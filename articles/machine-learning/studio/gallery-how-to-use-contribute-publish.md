...
* **[Řešení](gallery-solutions.md)**  – rychle vytvářet řešení Cortana Intelligence z předkonfigurovaných řešení, referenční dokumentace architektury a vzory návrhu. Je proveďte vlastní zahrnuté pokyny nebo s doporučenou partnera.
* **[Kurzy](gallery-tutorials.md)**  – počet kurzy jsou k dispozici pro vás provede procesem technologie machine learning a koncepty, nebo k popisu rozšířené metody pro řešení problémů learning různé počítače.

Tyto základní prostředky Galerie je možné seskupit logicky několik různými způsoby:

* **[Kolekce](gallery-collections.md)**  – kolekce umožňuje seskupit experimenty, rozhraní API, a další galerie položek tuto adresu specifického řešení nebo koncept.
* **[Odvětví](gallery-industries.md)**  -část odvětví Galerie spojuje různé prostředky, které jsou specifické pro takové odvětví jako prodejní, výroby, bankovnictví a zdravotní péče.
...
![Zobrazit příspěvky vytvářením obsahu](./media/gallery-how-to-use-contribute-publish/view-by-author.png)
...
![Sdílet tuto položku s friends](./media/gallery-how-to-use-contribute-publish/comment-and-share.png)
...
![Sdílet tuto položku s friends](./media/gallery-how-to-use-contribute-publish/view-and-download-counts.png)
...
![Postupujte podle komentáře uživatelů](./media/gallery-how-to-use-contribute-publish/follow-comments.png)
