---
title: "Azure json zásady ukázkové – vynutit značku a její hodnota | Microsoft Docs"
description: "Tato ukázková zásada json vyžaduje zadaný název značky a hodnotu."
...
---
# <a name="enforce-tag-and-its-value"></a>Vynutit značku a její hodnota

Tato zásada vyžaduje zadaný název značky a hodnotu. Zadáte název značky a hodnotu vynutit.
