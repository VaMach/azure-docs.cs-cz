---
title: "Azure json zásady ukázkové – vynutit vzor pro shodu | Microsoft Docs"
description: "Tato ukázková zásada json vyžaduje, aby splňovaly prostředky vzor pro shodu pro zásady vytváření názvů."
...
---
# <a name="enforce-match-pattern-for-naming-conventions"></a>Vynutit vzor pro shodu pro zásady vytváření názvů

Vyžadovat, například vzor názvů splňovat názvy prostředků. Určete vzorec povolené porovnání jako parametr.
