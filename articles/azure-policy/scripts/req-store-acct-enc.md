---
title: "Azure json zásady ukázkové – vyžadovat šifrování účtu úložiště | Microsoft Docs"
description: "Tato ukázková zásada json vyžaduje účet úložiště, který chcete použít šifrování objektů blob."
...
---
# <a name="require-storage-account-encryption"></a>Vyžadovat šifrování účtu úložiště

Tato zásada vyžaduje účet úložiště, který chcete použít šifrování objektů blob.
