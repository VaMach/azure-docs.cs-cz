---
title: "Azure ukázkové zásady json - povolené šířky pásma Express Route | Microsoft Docs"
description: "Tato ukázková zásada json vyžaduje, aby používal express trasy zadanou sadu šířek pásma."
...
---
# <a name="allowed-express-route-bandwidth"></a>Povolené Express Route šířky pásma

Tato zásada vyžaduje, aby používal express trasy zadanou sadu šířek pásma. Můžete zadat řadu skladových položek, které lze zadat pro Express Route.
