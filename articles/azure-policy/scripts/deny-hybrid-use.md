---
title: "Azure json zásady ukázkové – odepřít výhody použití hybridní | Microsoft Docs"
description: "Tato ukázková zásada json zakáže použití služby Azure hybridní použití zvýhodnění (AHUB)."
...
---
# <a name="deny-hybrid-use-benefit"></a>Výhody použití hybridní Odepřít

Zakáže použití služby Azure hybridní použití zvýhodnění (AHUB). Použijte, pokud nechcete povolit použití místní licencí.
