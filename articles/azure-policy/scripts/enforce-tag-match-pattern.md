---
title: "Azure json zásady ukázkové – vynutit vzor pro shodu značky | Microsoft Docs"
description: "Tato ukázková zásada json vyžaduje, aby splňovaly prostředky vzor pro shodu pro hodnotu značky."
...
---
# <a name="enforce-tag-match-pattern-for-tag-values"></a>Vynutit vzor pro shodu značky pro hodnoty značky

Vyžadovat, aby hodnota značky splňuje vzor pro shodu. Zadejte vzoru povolených v pravidlo zásad.
