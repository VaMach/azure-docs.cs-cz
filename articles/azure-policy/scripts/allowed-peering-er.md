---
title: "Azure ukázkové zásady json - povolené umístění partnerského vztahu Expressroute | Microsoft Docs"
description: "Tato zásada vyžaduje použití Express trasy umístění partnerského vztahu."
...
---
# <a name="allowed-peering-location-for-express-route"></a>Povolené umístění partnerského vztahu Expressroute

Tato zásada vyžaduje použití Express trasy umístění partnerského vztahu. Zadáte pole povolených umístění partnerského vztahu.
