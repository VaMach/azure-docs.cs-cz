---
title: "Azure json zásady ukázkové – vynutit jako vzor | Microsoft Docs"
description: "Tato ukázková zásada json vyžaduje, aby splňovaly prostředky například vzor pro vytváření názvů."
...
---
# <a name="enforce-like-pattern-for-naming-conventions"></a>Vynutit jako vzor pro vytváření názvů

Vyžadovat, například vzor názvů splňovat názvy prostředků. Zadejte povolené maximum jako vzor jako parametr.
