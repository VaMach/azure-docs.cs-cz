---
title: "Azure json zásady ukázkové – Audit žádný správce Azure AD | Microsoft Docs"
description: "Tato ukázková zásada json audity po žádný správce Azure Active Directory přiřazené k systému SQL server."
...
---
# <a name="audit-no-azure-active-directory-administrator"></a>Audit žádný správce Azure Active Directory

Audit, když není žádný správce Azure Active Directory přiřazené k systému SQL server.
