---
title: Začínáme s Azure Data Lake Analytics pomocí Portálu Azure | Microsoft Docs
...
3. Zadejte nebo vyberte tyto položky:
...
4. Vyberte položku **Připnout na Úvodní panel**. Je to nezbytné pro absolvování tohoto kurzu.
5. Klikněte na možnost **Vytvořit**. Tím přejdete na Úvodní panel portálu. Na Úvodní panel se přidá nová dlaždice s popiskem „Nasazení Azure Data Lake Analytics“. Vytvoření účtu Data Lake Analytics chvíli trvá. Jakmile je účet vytvořený, portál ho otevře v novém okně portálu.
...
6. V okně účtu Data Lake Analytics klikněte nahoře na možnost **Průzkumník dat**. 
...
7. V okně výchozího účtu Data Lake Store rozbalte složku kliknutím na možnost **Ukázky** a potom rozbalte složku kliknutím na možnost **Data**. Zobrazí se tyto soubory a složky:
...
1. Klikněte shora na možnost **Odeslat úlohu**. Otevře se nové podokno Podrobnosti úlohy. V záhlaví se zobrazuje stav úlohy.   
2. Počkejte, až se stav úlohy změní na **Úspěch**. Když se úloha dokončí, portál otevře nové okno s podrobnostmi o úloze:
...
3. V dolní části okna **Podrobnosti úlohy** klikněte na název úlohy v souboru **SearchLog-from-Data-Lake.csv**. Můžete stáhnout, přejmenovat nebo odstranit výstupní soubor nebo zobrazit jeho náhled.
...
4. Kliknutím na položku **Náhled** zobrazte výstupní soubor.
