...
> [!NOTE]
> Některé moduly se dodávají jako „globální“ moduly ve službě Automation. Tyto globální moduly jsou okamžitě dostupné po vytvoření účtu automatizace a my je někdy aktualizujeme, což je automaticky nasadí do účtu automatizace. Pokud nechcete používat automatické aktualizace, můžete vždy importovat stejný modul sami a ten bude mít přednost před globální verzí modulu, dodávanou v rámci služby. 
> 
> 
