...
<!-- URLs. -->
[Send email from Mobile Services with SendGrid]: /zh-cn/documentation/articles/store-sendgrid-mobile-services-send-email-scripts/
[Schedule backend jobs in Mobile Services]: /zh-cn/documentation/articles/mobile-services-dotnet-backend-schedule-recurring-tasks
[Get started with Mobile Services]: /zh-cn/documentation/articles/mobile-services-windows-store-dotnet-get-started
