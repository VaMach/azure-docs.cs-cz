...
2. Klikněte na tlačítko **přidat Moje IP** na panelu nástrojů. Tím se vytvoří pravidlo automaticky s IP adresou tohoto počítače, kterou posuzuje systému Azure.
...
4. Přidáte další adresní rozsahy. V pravidlech pro databázi Azure pro bránu firewall PostgreSQL můžete zadat jednu IP adresu nebo rozsah adres. Pokud chcete omezit platnost pravidla pro jednu IP adresu, zadejte stejnou adresu v poli pro počáteční IP a koncová IP adresa. Otevření brány firewall umožňuje správcům a uživatelům k přihlášení k jakékoli databázi na serveru PostgreSQL, k němuž mají platné přihlašovací údaje.
...
* Pokud chcete odstranit existující pravidlo, klikněte na tlačítko se třemi tečkami [...] a klikněte na tlačítko odebrat odstranit pravidlo. Kliknutím na **Uložit** uložte změny.
