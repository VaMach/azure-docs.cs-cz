...
2. After you update the service configuration file, upload and apply the configuration updates:
	...
	**Upload a New Configuration File** opens.
	...
	Unless you define at least two instances of every role, Azure cannot guarantee at least 99.95 percent availability of your cloud service during service configuration updates. For more information, see [Service Level Agreements](http://www.windowsazure.com/zh-cn/support/legal/sla/).
...
1. Log in to the [Management Portal](http://manage.windowsazure.cn/) and click **Cloud Services**. Then click the name of the cloud service to open the dashboard.
...
[Set Up a Remote Desktop Connection for a Role in Azure]: http://msdn.microsoft.com/zh-cn/library/windowsazure/hh124107.aspx
