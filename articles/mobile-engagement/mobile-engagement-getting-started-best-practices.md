<properties 
    pageTitle="Příručka Začínáme k Azure Mobile Engagement s osvědčenými postupy"
...
>[AZURE.NOTE] Ujistěte se, že je obsah odesílaný jako nabízené oznámení kompatibilní s pravidly příslušné platformy (iOS, Android, Windows) pro vývoj aplikací a odesílání nabízených oznámení.
