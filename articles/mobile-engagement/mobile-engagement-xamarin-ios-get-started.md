<properties
    pageTitle="Začínáme s Azure Mobile Engagementem pro Xamarin.iOS"
...
3. Vyplňte pole **App Name** (Název aplikace) a **Organization Identifier** (Identifikátor organizace) a potom klikněte na tlačítko **Next** (Další). 
    ...
    > [AZURE.IMPORTANT] Ujistěte se, že profil publikování, který nakonec použijete k nasazení své aplikace pro iOS, používá ID aplikace, které přesně odpovídá vašemu identifikátoru svazku. 
