...
| --- | --- |
| INTERNET |Vyžaduje se. Pro základní vytváření sestav |
| ACCESS_NETWORK_STATE |Vyžaduje se. Pro základní vytváření sestav |
| RECEIVE_BOOT_COMPLETED |Vyžaduje se. Objeví centru oznámení po restartování zařízení |
