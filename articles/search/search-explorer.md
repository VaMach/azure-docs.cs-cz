<properties
    pageTitle="Dotazování indexu Azure Search pomocí Portálu Azure | Microsoft Azure | Hostovaná cloudová vyhledávací služba"
    description="Vydejte vyhledávací dotaz v Průzkumníku služby Search na Portálu Azure."
    services="search"
    documentationCenter=""
    authors="ashmaka"
/>
...
<tags
    ...
    ms.author="ashmaka"
/>
# Dotazování indexu Azure Search pomocí Portálu Azure
> [AZURE.SELECTOR]
...
Tento návod vám ukáže, jak dotazovat index Azure Search na Portálu Azure.
...
1. V nabídce na levé straně [Portálu Azure](https://portal.azure.com/#blade/HubsExtension/BrowseResourceBlade/resourceType/Microsoft.Search%2FsearchServices) klikněte na možnost Všechny prostředky.
