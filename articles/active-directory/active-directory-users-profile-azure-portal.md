...
1. Přihlaste se k [centra pro správu Azure AD](https://aad.portal.azure.com) pomocí účtu, který je globální správce adresáře.
...
3. Vyberte **všichni uživatelé**.
   ...
   ![Otevírání všechny skupiny uživatelů](./media/active-directory-users-profile-azure-portal/create-users-open-users-blade.png)
1. Vyberte uživatele ze seznamu.
2. Pro vybraného uživatele, vyberte **profil**.
