<properties
    pageTitle="Jak je předplatné Azure propojeno se službou Azure Active Directory | Microsoft Azure"
...
## Účty, které můžete použít pro přihlášení
...
## Jak předplatné služby Azure souvisí se službou Azure AD
...
## Správa předplatného a adresáře
...
## Proč nemůžu spravovat adresář pomocí aktuálního uživatelského účtu?
...
## Použití pracovního nebo školního účtu ke správě předplatného služby Azure, které bylo vytvořeno pomocí účtu Microsoft
...
## Přihlášení po použití pracovního e-mailu pro účet Microsoft
...
### Mám předplatné služby Azure pomocí účtu Microsoft
