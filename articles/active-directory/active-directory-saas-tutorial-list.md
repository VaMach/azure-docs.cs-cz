...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-adaptivesuite-tutorial.png)| [Adaptivní Suite](active-directory-saas-adaptivesuite-tutorial.md)|
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-adobe-creative-cloud-tutorial.png)| [Adobe Creative cloudu](active-directory-saas-adobe-creative-cloud-tutorial.md)|
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-adobeexperiencemanager-tutorial.png)| [Adobe činnost správce](active-directory-saas-adobeexperiencemanager-tutorial.md)|
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-adobe-echosign-tutorial.png)| [Adobe přihlášení](active-directory-saas-adobe-echosign-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-apexportal-tutorial.png)| [Vrcholu portálu](active-directory-saas-apexportal-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-asana-tutorial.png)| [Asana](active-directory-saas-asana-tutorial.md)|[Asana - zřizování uživatelů](active-directory-saas-asana-provisioning-tutorial.md)|
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-asccontracts-tutorial.png)| [Kontrakty ASC](active-directory-saas-asccontracts-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-birst-tutorial.png)| [Birst agilní obchodní analýza](active-directory-saas-birst-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-blackboard-learn-tutorial.png)| [Další tabule](active-directory-saas-blackboard-learn-tutorial.md)|
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-blackboard-learn-shibboleth-tutorial.png)| [Další tabule - Shibboleth](active-directory-saas-blackboard-learn-shibboleth-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-bridge-tutorial.png)| [Most](active-directory-saas-bridge-tutorial.md)|
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-brightspace-desire2learn-tutorial.png)| [Brightspace podle Desire2Learn](active-directory-saas-brightspace-desire2learn-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-cappm-tutorial.png)| [CERTIFIKAČNÍ AUTORITY STRAN ZA MINUTU](active-directory-saas-cappm-tutorial.md)|
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-canvas-lms-tutorial.png)| [Plátno pro správu vzdělávacího procesu](active-directory-saas-canvas-lms-tutorial.md)|
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-capriza-tutorial.png)| [Capriza platformy](active-directory-saas-capriza-tutorial.md)|
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-carlsonwagonlit-tutorial.png)| [Cesta Wagonlit Carlson](active-directory-saas-carlsonwagonlit-tutorial.md)|
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-central-desktop-tutorial.png)| [Centrální plochy](active-directory-saas-central-desktop-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-cernercentral-tutorial.png)| [Cerner – střed](active-directory-saas-cernercentral-tutorial.md)|[Střed Cerner - zřizování uživatelů](active-directory-saas-cernercentral-provisioning-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-clearreview-tutorial.png)| [Clear – kontrola](active-directory-saas-clearreview-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-newsignature-tutorial.png)| [Portál pro správu cloudu pro Microsoft Azure](active-directory-saas-newsignature-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-complianceelf-tutorial.png)| [Dodržování předpisů ELF](active-directory-saas-complianceelf-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-cornerstone-ondemand-tutorial.png)| [Základním kamenem OnDemand](active-directory-saas-cornerstone-ondemand-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-deputy-tutorial.png)| [Zástupce](active-directory-saas-deputy-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-directions-microsoft-tutorial.png)| [Pokyny, společnost Microsoft](active-directory-saas-directions-microsoft-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-dome9arc-tutorial.png)| [Dome9 oblouk](active-directory-saas-dome9arc-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-dowjones-factiva-tutorial.png)| [Rdit Petr Factiva](active-directory-saas-dowjones-factiva-tutorial.md)|
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-dropboxforbusiness-tutorial.png)| [Dropbox pro firmy](active-directory-saas-dropboxforbusiness-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-efidigitalstorefront-tutorial.png)| [Digitální výkladní skříň EFI](active-directory-saas-efidigitalstorefront-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-encompass-tutorial.png)| [Zahrnuje](active-directory-saas-encompass-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-fidelitynetbenefits-tutorial.png)| [Přesnost NetBenefits](active-directory-saas-fidelitynetbenefits-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-github-tutorial.png)| [GitHub](active-directory-saas-github-tutorial.md)|[GitHub - zřizování uživatelů](active-directory-saas-github-provisioning-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-citrix-gotomeeting-tutorial.png)| [GoToMeeting](active-directory-saas-citrix-gotomeeting-tutorial.md)|[GoToMeeting - zřizování uživatelů](active-directory-saas-citrixgotomeeting-provisioning-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-halogen-software-tutorial.png)| [Halogen softwaru](active-directory-saas-halogen-software-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-helpscout-tutorial.png)| [Scout nápovědy](active-directory-saas-helpscout-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-hostedgraphite-tutorial.png)| [Hostované grafitová](active-directory-saas-hostedgraphite-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-shiftplanning-tutorial.png)| [Lidskosti](active-directory-saas-shiftplanning-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-icertisicm-tutorial.png)| [Platforma pro správu Icertis kontraktu](active-directory-saas-icertisicm-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-igloo-software-tutorial.png)| [Igloo softwaru](active-directory-saas-igloo-software-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-insigniasamlsso-tutorial.png)| [Jednotné přihlašování SAML odznaky](active-directory-saas-insigniasamlsso-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-iqualify-tutorial.png)| [iQualify pro správu vzdělávacího procesu](active-directory-saas-iqualify-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-keeperpasswordmanager-tutorial.png)| [Správce hesel držitel & digitální trezoru](active-directory-saas-keeperpasswordmanager-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-knowbe4-tutorial.png)| [KnowBe4 zabezpečení sledování školení](active-directory-saas-knowbe4-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-landgorilla-tutorial.png)| [Krajině Gorilla klienta](active-directory-saas-landgorilla-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-learning-at-work-tutorial.png)| [Učení v práci](active-directory-saas-learning-at-work-tutorial.md)|
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-learningseatlms-tutorial.png)| [Learning stanici pro správu vzdělávacího procesu](active-directory-saas-learningseatlms-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-lifesize-cloud-tutorial.png)| [Lifesize cloudu](active-directory-saas-lifesize-cloud-tutorial.md)|
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-worksmobile-tutorial.png)| [ŘÁDEK FUNGUJE](active-directory-saas-worksmobile-tutorial.md)|
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-linkedinelevate-tutorial.png)| [Zvýšení oprávnění LinkedIn](active-directory-saas-linkedinelevate-tutorial.md)|[Zvýšení oprávnění LinkedIn - uživatele zřizování](active-directory-saas-linkedinelevate-provisioning-tutorial.md)|
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-linkedinlearning-tutorial.png)| [LinkedIn Learning](active-directory-saas-linkedinlearning-tutorial.md)|[Učení LinkedIn – zřizování uživatelů](active-directory-saas-linkedinlearning-provisioning-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-menlosecurity-tutorial.png)| [Menlo zabezpečení](active-directory-saas-menlosecurity-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-jiramicrosoft-tutorial.png)| [Microsoft Azure Active Directory jednotné přihlašování pro JIRA](active-directory-saas-jiramicrosoft-tutorial.md)|
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-mimecast-admin-console-tutorial.png)| [Konzola pro správu Mimecast](active-directory-saas-mimecast-admin-console-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-mobilexpense-tutorial.png)| [Mobilní Xpense](active-directory-saas-mobilexpense-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-moveittransfer-tutorial.png)| [Přenos MOVEit – integrace Azure AD](active-directory-saas-moveittransfer-tutorial.md)|
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-moxiengage-tutorial.png)| [Moxi provozovat](active-directory-saas-moxiengage-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-netsuite-tutorial.png)| [Netsuite](active-directory-saas-netsuite-tutorial.md)|[Netsuite - zřizování uživatelů](active-directory-saas-netsuite-provisioning-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-oc-tanner-tutorial.png)| [O.C. Nováková - AppreciateHub](active-directory-saas-oc-tanner-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-onetrust-tutorial.png)| [Software pro správu OneTrust ochrany osobních údajů](active-directory-saas-onetrust-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-paloaltoadmin-tutorial.png)| [Palo Alto sítě - Správce uživatelského rozhraní](active-directory-saas-paloaltoadmin-tutorial.md)|
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-paloaltonetworks-captiveportal-tutorial.png)| [Palo Alto Networks - další zpracování portálu](active-directory-saas-paloaltonetworks-captiveportal-tutorial.md)|
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-paloaltoglobalprotect-tutorial.png)| [Palo Alto sítě - GlobalProtect](active-directory-saas-paloaltoglobalprotect-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-pegasystems-tutorial.png)| [Pega systémy](active-directory-saas-pegasystems-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-pingboard-tutorial.png)| [Pingboard](active-directory-saas-pingboard-tutorial.md)|[Pingboard - zřizování uživatelů](active-directory-saas-pingboard-provisioning-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-predictix-assortment-planning-tutorial.png)| [Plánování sortimentu Predictix](active-directory-saas-predictix-assortment-planning-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-predictixpricereporting-tutorial.png)| [Cena Predictix vytváření sestav](active-directory-saas-predictixpricereporting-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-procoresso-tutorial.png)| [Procore jednotného přihlašování](active-directory-saas-procoresso-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-proofpoint-ondemand-tutorial.png)| [Proofpoint na vyžádání](active-directory-saas-proofpoint-ondemand-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-rally-software-tutorial.png)| [Technologie Rally softwaru](active-directory-saas-rally-software-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-redbrickhealth-tutorial.png)| [RedBrick stavu](active-directory-saas-redbrickhealth-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-rollbar-tutorial.png)| [Oblouk](active-directory-saas-rollbar-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-salesforce-tutorial.png)| [Salesforce](active-directory-saas-salesforce-tutorial.md)|[Salesforce - zřizování uživatelů](active-directory-saas-salesforce-provisioning-tutorial.md)|
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-salesforce-sandbox-tutorial.png)| [Izolovaný prostor Salesforce](active-directory-saas-salesforce-sandbox-tutorial.md)|[Izolovaný prostor Salesforce - zřizování uživatelů](active-directory-saas-salesforce-sandbox-provisioning-tutorial.md)|
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-samanage-tutorial.png)| [Samanage](active-directory-saas-samanage-tutorial.md)|[Samanage - zřizování uživatelů](active-directory-saas-samanage-provisioning-tutorial.md)|
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-bamboo-tutorial.png)| [Jednotné přihlašování SAML pro bambus podle řešení GmbH](active-directory-saas-bamboo-tutorial.md)|
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-bitbucket-tutorial.png)| [Jednotné přihlašování SAML pro Bitbucket podle řešení GmbH](active-directory-saas-bitbucket-tutorial.md)|
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-samlssoconfluence-tutorial.png)| [Jednotné přihlašování SAML pro soutoku podle řešení GmbH](active-directory-saas-samlssoconfluence-tutorial.md)|
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-samlssojira-tutorial.png)| [Jednotné přihlašování SAML pro Jira podle řešení GmbH](active-directory-saas-samlssojira-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-sapboc-tutorial.png)| [SAP Business objektu cloudu](active-directory-saas-sapboc-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-sap-hana-cloud-platform-tutorial.png)| [Cloudová platforma SAP](active-directory-saas-sap-hana-cloud-platform-tutorial.md)|
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-sap-hana-cloud-platform-identity-authentication-tutorial.png)| [SAP cloudové platformy identitu ověřování](active-directory-saas-sap-hana-cloud-platform-identity-authentication-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-scc-lifecycle-tutorial.png)| [Životní cyklus SCC](active-directory-saas-scc-lifecycle-tutorial.md)|
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-scclifecycle-tutorial.png)| [Životní cyklus SCC](active-directory-saas-scclifecycle-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-servicenow-tutorial.png)| [ServiceNow](active-directory-saas-servicenow-tutorial.md)|[ServiceNow - zřizování uživatelů](active-directory-saas-servicenow-provisioning-tutorial.md)|
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-shmoopforschools-tutorial.png)| [Shmoop pro školy](active-directory-saas-shmoopforschools-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-silkroad-life-suite-tutorial.png)| [Sada SilkRoad životnosti](active-directory-saas-silkroad-life-suite-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-skillsmanager-tutorial.png)| [Dovednosti Manager](active-directory-saas-skillsmanager-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-splunkenterpriseandsplunkcloud-tutorial.png)| [Splunk Enterprise a Splunk cloudu](active-directory-saas-splunkenterpriseandsplunkcloud-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-tyeexpress-tutorial.png)| [N & E Express](active-directory-saas-tyeexpress-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-tableauserver-tutorial.png)| [Tableau serveru](active-directory-saas-tableauserver-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-thousandeyes-tutorial.png)| [ThousandEyes](active-directory-saas-thousandeyes-tutorial.md)|[ThousandEyes - zřizování uživatelů](active-directory-saas-thousandeyes-provisioning-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-topdesk-secure-tutorial.png)| [TOPdesk - zabezpečení](active-directory-saas-topdesk-secure-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-versal-tutorial.png)| [Versal odkazů](active-directory-saas-versal-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-wizergosproductivitysoftware-tutorial.png)| [Wizergos produktivitu softwaru](active-directory-saas-wizergosproductivitysoftware-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-workplacebyfacebook-tutorial.png)| [Síti na pracovišti ve službě Facebook.](active-directory-saas-workplacebyfacebook-tutorial.md)|
...
| ![Logo](./media/active-directory-saas-tutorial-list/active-directory-saas-zscalerprivateaccess-tutorial.png)| [Přístup privátního Zscaler (ZPA)](active-directory-saas-zscalerprivateaccess-tutorial.md)|
