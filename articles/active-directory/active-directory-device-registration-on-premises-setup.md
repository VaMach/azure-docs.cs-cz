...
Nyní když uživatelé přístup k aplikaci ze zařízení, které není registrován u službu Azure Active Directory device registration service, uvidí stránky, který bude vypadat podobně jako na následujícím snímku obrazovky.
