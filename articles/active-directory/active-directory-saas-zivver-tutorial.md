...
V tomto kurzu zjistěte, jak integrovat ZIVVER s Azure Active Directory (Azure AD).

Integrace ZIVVER s Azure AD poskytuje následující výhody:

- Můžete ovládat ve službě Azure AD, který má přístup k ZIVVER.
- Můžete povolit uživatelům, aby automaticky získat přihlášení k ZIVVER (jednotné přihlášení) s jejich účty Azure AD.
...
Při konfiguraci integrace ZIVVER do služby Azure AD musíte přidat do seznamu spravovaných aplikací SaaS ZIVVER z galerie.
...
4. Do vyhledávacího pole zadejte **ZIVVER**, vyberte **ZIVVER** z panelu výsledků klikněte **přidat** tlačítko Přidat aplikaci.
...
Azure AD pro jednotné přihlašování pro práci, musí vědět, co uživatel protějškem v ZIVVER je pro uživatele ve službě Azure AD. Jinými slovy odkaz vztah mezi uživatele Azure AD a související uživatelské v ZIVVER musí navázat.

V ZIVVER, přiřadit hodnotu **uživatelské jméno** ve službě Azure AD jako hodnotu **uživatelské jméno** k navázání vztahu odkazu.

Nakonfigurovat a otestovat Azure AD jednotné přihlašování s ZIVVER, je třeba dokončit následující stavební bloky:

1. **[Konfigurovat Azure AD jednotné přihlašování](#configure-azure-ad-single-sign-on)**  – Pokud chcete povolit uživatelům tuto funkci používat.
2. **[Vytvořit testovací uživatele Azure AD](#create-an-azure-ad-test-user)**  – Pokud chcete otestovat Azure AD jednotné přihlašování s Britta Simon.
3. **[Vytvoření zkušebního uživatele ZIVVER](#create-a-zivver-test-user)**  – Pokud chcete mít protějšek Britta Simon v ZIVVER propojeném s Azure AD reprezentace daného uživatele.
4. **[Přiřadit testovacího uživatele Azure AD](#assign-the-azure-ad-test-user)**  – Pokud chcete povolit Britta Simon používat Azure AD jednotné přihlašování.
5. **[Test jednotného přihlašování](#test-single-sign-on)**  – Pokud chcete ověřit, zda je funkční konfigurace.

### <a name="configure-azure-ad-single-sign-on"></a>Konfigurovat Azure AD jednotné přihlašování

V této části můžete povolit Azure AD jednotného přihlašování na portálu Azure a nakonfigurovat jednotné přihlašování v aplikaci ZIVVER.

**Ke konfiguraci Azure AD jednotné přihlašování s ZIVVER, proveďte následující kroky:**

1. Na portálu Azure na **ZIVVER** stránky integrace aplikací, klikněte na tlačítko **jednotného přihlašování**.
...
3. Na **ZIVVER domény a adresy URL** část, proveďte následující kroky:
    ...
    V **identifikátor** textovému poli, zadejte adresu URL:`https://app.zivver.com/SAML/Zivver`
...
6. Konfigurace jednotného přihlašování na **ZIVVER** straně, budete muset odeslat stažené **soubor XML s metadaty** k [tým podpory ZIVVER](https://support.zivver.com). Nastavují toto nastavení tak, aby měl jednotné přihlašování SAML připojení správně nastavena na obou stranách.
...
V této části vytvoříte volal Britta Simon v ZIVVER uživatele. Práce s [tým podpory ZIVVER](https://support.zivver.com) přidat uživatele do ZIVVER platformy.

### <a name="assign-the-azure-ad-test-user"></a>Přiřadit testovacího uživatele Azure AD

V této části povolíte Britta Simon používat Azure jednotné přihlašování pomocí udělení přístupu ZIVVER.

![Přiřadit role uživatele][200] 

**Pokud chcete přiřadit Britta Simon ZIVVER, proveďte následující kroky:**
...
Když kliknete na dlaždici ZIVVER na přístupovém panelu, jste měli získat automaticky přihlášení k aplikaci ZIVVER.
