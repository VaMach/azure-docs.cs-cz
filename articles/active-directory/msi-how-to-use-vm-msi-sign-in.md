...
[!INCLUDE[preview-notice](../../includes/active-directory-msi-preview-notice.md)]Tento článek obsahuje příklady skriptů prostředí PowerShell a rozhraní příkazového řádku pro přihlašování pomocí služby MSI instančního objektu a pokyny na důležité oblastech, jako je zpracování chyb.
