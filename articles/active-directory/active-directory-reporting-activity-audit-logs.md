...
Pokud jako **Typ prostředku aktivity** vyberete **Skupina**, získáte další možnost filtru, která vám umožňuje filtrovat také na základě následujících **zdrojů aktivit**:
