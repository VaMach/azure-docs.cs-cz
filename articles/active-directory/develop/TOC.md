...
### [Zobrazení kódu SAML vráceného službou Access Control](active-directory-java-view-saml-returned-by-access-control.md)
...
### [Co se stalo s mým projektem MVC](Visual Studio Azure Active Directory connected service.md)?](vs-active-directory-dotnet-what-happened
...
## [Instanční objekty aplikací a služeb](active-directory-application-objects.md)
...
# [Koncový bod verze 2.0](active-directory-appmodel-v2-overview.md)
...
### [OAuth 2.0 a OpenID](active-directory-v2-protocols.md)
