...
| Parametr | Popis |
| --- | --- |
| access_token |Požadovaný přístupový token jako podepsaný JSON Web Token (JWT). Aplikace můžete používat tento token k ověření zabezpečeným prostředkům, jako jsou webové rozhraní API. |
