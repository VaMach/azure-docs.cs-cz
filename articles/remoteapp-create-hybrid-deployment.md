...
- Install the [Azure PowerShell](http://azure.microsoft.com/zh-cn/documentation/articles/install-configure-powershell/) module.
...
1. In the [Windows Azure Management Portal](http://manage.windowsazure.cn), go to the RemoteApp page.
