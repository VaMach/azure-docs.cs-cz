...
| keyFilePath | Úplná cesta k souboru klíče .p12, který se používá k ověření e-mailovou adresu účtu služby a lze použít pouze na vlastním hostováním infračerveného signálu.  | Ne |
