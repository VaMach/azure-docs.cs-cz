...
> [AZURE.IMPORTANT] Než se pustíte do tohoto kurzu, přečtěte si článek [Přehled a požadavky kurzu](data-factory-copy-data-from-azure-blob-storage-to-sql-database.md) obsahující přehled kurzu a proveďte **nutné** kroky.
...
3. Pro skupinu prostředků proveďte jeden z následujících kroků: 1. Vyberte možnost **Použít existující** a vyberte existující skupinu prostředků.
2. Vyberte možnost **Vytvořit nový** a zadejte název pro skupinu prostředků.
    ...
    3. Vyberte **umístění** pro příslušný objekt pro vytváření dat.
    4. Zaškrtněte políčko **Připnout na řídicí panel** v dolní části okna.  
...
7. Na stránce **Zvolte vstupní soubor nebo složku** klikněte na **Další**. Nezaškrtávejte políčko **Binární kopie**. 
...
9. Na stránce **Specify the Azure SQL database** (Určete databázi SQL Azure):
    ...
    3. Vyberte své **předplatné** Azure.  
    2. Vyberte možnosti v polích **Název serveru** a **Databáze**.
...
11. Na stránce **Nastavení výkonu** klikněte na **Další**. 
...
13. Pomocí pokynů v tématu [Monitorování a správa kanálu pomocí monitorovací aplikace](data-factory-monitor-manage-app.md) zjistíte, jak můžete vytvořený kanál monitorovat. Kliknutím na ikonu **Aktualizovat** v seznamu **OKNA AKTIVIT** zobrazíte řez. 
    ...
    > [AZURE.NOTE] Kliknutím na tlačítko **Aktualizovat** v seznamu **OKNA AKTIVITY** ve spodní části zobrazte nejnovější stav. Zobrazení se neobnovuje automaticky. 
