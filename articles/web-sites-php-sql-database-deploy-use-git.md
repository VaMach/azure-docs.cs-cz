...
2. Browse to **http://[site name].chinacloudsites.cn/createtable.php** to create the MySQL table for the application.
3. Browse to **http://[site name].chinacloudsites.cn/index.php** to begin using the application.
...
3. Browse to **http://[site name].chinacloudsites.cn/index.php** to see your changes.
