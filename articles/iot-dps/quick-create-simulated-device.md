...
---
# <a name="create-and-provision-a-simulated-device-using-iot-hub-device-provisioning-services"></a>Vytvoření a zřízení simulovaného zařízení pomocí služeb Azure IoT Hub Device Provisioning
