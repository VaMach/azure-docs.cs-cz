...
5. Then specify the **Host** and **Points To** fields for the record. When complete click the **Add** button.
    ...
    * When adding a CNAME record, you must set the **Host** field to the sub-domain you wish to use. For example, **www**. You must set the **Points To** field to the **.trafficmanager.cn** domain name of the Traffic Manager profile you are using with your Azure Web Site. For example, **contoso.trafficmanager.cn**.
