...
## [Generování sdílených přístupových podpisů](service-bus-sas-overview.md)
...
### [Použití AMQP s .NET API](service-bus-dotnet-advanced-message-queuing.md)
