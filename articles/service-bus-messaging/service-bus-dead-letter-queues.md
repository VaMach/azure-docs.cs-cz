...
Tento článek popisuje fronty nedoručených zpráv v Azure Service Bus. Hodně diskuse je zobrazená ve [fronty nedoručených zpráv ukázka](https://github.com/Azure/azure-service-bus/tree/master/samples/DotNet/Microsoft.ServiceBus.Messaging/DeadletterQueue) na Githubu.
...
Všimněte si, že žádné automatické čištění DLQ se. Zprávy zůstávají v DLQ se, dokud je explicitně načíst z DLQ se a volání [Complete()](/dotnet/api/microsoft.servicebus.messaging.brokeredmessage#Microsoft_ServiceBus_Messaging_BrokeredMessage_CompleteAsync) na nedoručených zpráv.
...
Získá během pohybu zprostředkovatelem zprávy, dvě vlastnosti jsou přidány do zprávy jako zprostředkovatel volá jeho vnitřní verzi [nedoručených zpráv](/dotnet/api/microsoft.servicebus.messaging.brokeredmessage#Microsoft_ServiceBus_Messaging_BrokeredMessage_DeadLetter_System_String_System_String_) na zprávu: `DeadLetterReason` a `DeadLetterErrorDescription`.
...
Chcete-li získat tyto zprávy lettered zpráv, můžete vytvořit příjemce pomocí [FormatTransferDeadletterPath](/dotnet/api/microsoft.servicebus.messaging.queueclient#Microsoft_ServiceBus_Messaging_QueueClient_FormatTransferDeadLetterPath_System_String_) metody nástrojů.
