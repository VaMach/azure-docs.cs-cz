...
Chcete-li nastavit tyto přenosy, vytvořte odesílatele zprávy, který cílí cílové fronty prostřednictvím fronty přenosu. Máte také příjemce, který žádá o zprávy z této fronty stejné. Příklad:
