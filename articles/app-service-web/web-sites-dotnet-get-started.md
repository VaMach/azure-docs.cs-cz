<properties
    pageTitle="Nasazení aplikace ASP.NET do služby Azure App Service pomocí sady Visual Studio | Microsoft Azure"
...
6. V dialogovém okně **Změna ověřování** klikněte na možnost **Bez ověřování** a poté klikněte na tlačítko **OK**.
...
5. Ujistěte se, zda je v části **Microsoft Azure** v dialogovém okně **Nový projekt ASP.NET** zaškrtnuta položka **Hostovat v cloudu** a zda je v rozevíracím seznamu vybrána položka **App Service**.
...
5. V dialogovém okně **Vytvoření služby App Service** klikněte na tlačítko **Přidat účet** a přihlaste se k Azure pomocí ID a hesla účtu, který používáte ke správě předplatného Azure.
...
3. Zadejte **Název webové aplikace**, který je v doméně *azurewebsites.net* jedinečný. Můžete ji například pojmenovat MyExample s číslem vpravo (např. MyExample810), a tím zajistit její jedinečnost. Pokud je pro vás vytvořen výchozí název webu, tento název je jedinečný a můžete jej použít.
...
6. Klikněte na tlačítko **Nový** vedle pole **Skupina prostředků** a zadejte název „MyExample“, případně jiný preferovaný název. 
...
5. V rozevíracím seznamu **Umístění** vyberte umístění, které je vám nejblíže.
...
6. V dialogovém okně **Konfigurace plánu služby App Service** klikněte na tlačítko **OK**.

7. V dialogovém okně **Vytvoření služby App Service** klikněte na možnost **Vytvořit**.
...
8. Na kartě **Připojení** průvodce **Publikování webu** klikněte na tlačítko **Další**.
    ...
    Následuje karta **Nastavení**. Zde můžete změnit konfiguraci sestavení a nasadit sestavení pro ladění za účelem [vzdáleného ladění](../app-service-web/web-sites-dotnet-troubleshoot-visual-studio.md#remotedebug). Na této kartě je také několik [možností publikování souboru](https://msdn.microsoft.com/library/dd465337.aspx#Anchor_2).

10. Na kartě **Nastavení** klikněte na tlačítko **Další**.
...
11. Na kartě **Náhled** klikněte na tlačítko **Publikovat**.
