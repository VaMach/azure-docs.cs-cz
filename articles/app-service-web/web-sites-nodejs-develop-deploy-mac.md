<properties
    pageTitle="Vytvoření webové aplikace Node.js ve službě Azure App Service | Microsoft Azure"
...
2. Do souboru **server.js** zkopírujte následující kód a soubor uložte:
...
3. Otevřete příkazový řádek a následujícím příkazem místně spusťte webovou aplikaci.

        node server.js

4. Otevřete webový prohlížeč a přejděte na adresu http://localhost:1337. 
...
1. V příkazovém řádku přejděte do adresáře **zdravímsvět** a zadáním následujícího příkazu inicializujte místní úložiště Git.

        git init


2. Pomocí následujících příkazů přidejte soubory do úložiště:

        git add .
        git commit -m "initial commit"

3. Následujícím příkazem přidejte vzdálené řízení Git pro nucené doručení (push) aktualizací do webové aplikace, kterou jste vytvořili dříve:

        git remote add azure [URL for remote repository]

4. Nuceně vložte (push) změny do Azure následujícím příkazem:
...
5. Chcete-li zobrazit aplikaci, klikněte na tlačítko **Procházet** v části **Webová aplikace** portálu Azure.
...
2. V příkazovém řádku přejděte do adresáře **zdravímsvět** a spusťte následující příkazy.
...
3. Aktualizujte okno prohlížeče, v němž jste přešli na adresu URL webové aplikace.
