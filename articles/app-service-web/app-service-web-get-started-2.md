...
V části [Nasazení první webové aplikace do Azure během pěti minut](app-service-web-get-started.md) jste nasadili ukázkovou webovou aplikaci do služby [Azure App Service](../app-service/app-service-value-prop-what-is.md). V tomto článku do nasazené webové aplikace rychle přidáte některé skvělé funkce. Během několik minut provedete tyto úkony:
