---
title: "Nasazení první webové aplikace v PHP do Azure během pěti minut | Dokumentace Microsoftu"
...
---
# <a name="deploy-your-first-php-web-app-to-azure-in-five-minutes"></a>Nasazení první webové aplikace v PHP do Azure během pěti minut
...
4. Přejděte do pracovního adresáře (`CD`) a naklonujte ukázkovou aplikaci v PHP tímto způsobem:
...
6. V Azure vytvořte prostředek aplikace služby App Service s jedinečným názvem aplikace a uživatelem nasazení, kterého jste nakonfigurovali v předchozích krocích. Po zobrazení výzvy zadejte číslo požadované oblasti.
    ...
    ![Vytvoření prostředku Azure pro první webovou aplikaci v Azure](./media/app-service-web-get-started-languages/php-site-create.png)
...
[Vytvořte, nakonfigurujte a nasaďte webovou aplikaci Laravel do Azure](app-service-web-php-get-started-cli-nodejs.md). V tomto kurzu se naučíte základní dovednosti, které v Azure potřebujete ke spuštění libovolné webové aplikace v PHP, jako je:
