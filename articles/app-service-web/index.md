...
---
# <a name="azure-web-apps-documentation"></a>Dokumentace ke službě Azure Web Apps

<div class="introHolder">
    <div class="intro">
Naučte se, jak pomocí App Service Web Apps vytvářet a hostovat weby a webové aplikace. Kurzy, videa, reference k rozhraní API a další dokumentace ukazují, jak můžete vyvíjet na této plně spravované výpočetní platformě.
    </div>
    <div class="calloutHolder">
        <div class="callout">
            <a href="https://azure.microsoft.com/community/training/courses/developing-dotnet-microsoft-azure-getting-started/">
                <img src="media/index/pluralsight.svg" /> Bezplatné školicí video k PluralSightu – Vývoj s využitím .NET v Microsoft Azure </a>
        </div>
    </div>
</div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Začínáme se službou Web Apps (video)</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Knihovna videí ke službě Web Apps</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Začínáme s Web Apps s využitím ASP.NET a sady Visual Studio</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Začínáme s Web Apps s využitím Javy</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Začínáme s Web Apps s využitím Node.js </h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Začínáme s Web Apps s využitím Python Tools 2.2</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Začínáme s Web Apps s využitím PHP</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Začínáme s WordPressem ve službě Azure App Service</h3>
                    </div>
                </div>
            </div>
        </div>
