...
Podrobnější informace týkající se používání stavu relace ASP.NET naleznete v tématu [Přehled stavu relace ASP.NET][Přehled stavu relace ASP.NET].
