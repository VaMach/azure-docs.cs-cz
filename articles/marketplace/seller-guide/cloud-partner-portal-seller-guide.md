...
Vítejte v Průvodci prodejce Azure Marketplace. Tato příručka je určená pro firmy uživatelům a správcům produktu v nezávislí dodavatelé softwaru (ISV), kteří mají zájem o prodávané jejich bitové kopie virtuálních počítačů Azure certifikované pro odborníky v oblasti IT a vývojářům. S Azure zákazníky po celém světě, nachází [Marketplace](https://azuremarketplace.microsoft.com/) poskytne skvělé reach a ohrožení vaší produktů.


> [!NOTE]
> Pokud vás zajímá prodávané dokončení software jako služba (SaaS) produkty firemním uživatelům, můžete prozkoumat možnosti je v [AppSource](https://appsource.microsoft.com).
...
Azure Marketplace se online marketplace aplikací a služeb, na kterém ISV--z startupy podnikům – nabízet svá řešení Azure zákazníkům po celém světě. Přes Marketplace můžete Azure vydavatele distribuce a prodeje jejich bitové kopie virtuálních počítačů pro jiné profesionály, kteří chtějí rychle vyvíjet vlastní cloudové aplikace a mobilní řešení v Azure. Na webu Marketplace podporuje celou řadu nabídky--z aplikací analýzy dat začátku do konce s zpracování dat, úložiště dat a analýzu vrstvy, elektronické obchodování vrstvené aplikace (data, služba a Internetu).

Cloud se zákazníci setkávají několik problémy při hledání řešení podle jejich potřeb jedinečný. Na webu Marketplace nabízí způsob, jak vyřešit tyto problémy a připojit zákazníků s inovativní řešení ISV, jak je popsáno v následující tabulce:
...
Na webu Marketplace přináší kvality, výběru a sílu ekosystému Azure partnera pro globální zákazníků. Mezi klíčové výhody patří:
...
## <a name="is-the-marketplace-right-for-my-business"></a>Je nejvhodnější Marketplace pro firmy?
...
## <a name="what39s-the-customer-base-for-the-marketplace"></a>Jaký & č. 39; s zákaznická základna pro Marketplace?
...
## <a name="how-does-the-marketplace-work"></a>Jak funguje Marketplace?

Vyb & č. 39; s velmi snadné. Můžete & č. 39; po schválení znovu vytvořit bitové kopie virtuálního počítače Azure certifikaci a publikujete ho v Marketplace. Můžete najít Azure zákazníků, tam si zakoupit a nasaďte svůj produkt v minutách. Zákazníci i lépe nasadit řešení s jistotou. Vědí, že prostředí je nakonfigurován pro úspěch v Azure a že infrastruktury je připravené na vynucování během několika minut.

Portál pro partnery cloudu je centrem pro vytvoření vaší nabídky na Marketplace. Bitové kopie virtuálních počítačů jsou předem nakonfigurovány plně nainstalovaného operačního systému a jednu nebo více aplikací. Chcete-li certifikovat image proto to & č. 39; s připravené pro publikace, je nutné splnit určité požadavky. V další části probereme.


## <a name="whats-next"></a>Co dále?

Vám může přemýšlíte Azure Marketplace je opravdu vpravo fit pro svůj produkt. Jak tedy začít? V této části se točí kolem zprovoznění na Marketplace (obrázek 1) pomocí: 
* Aby se aktivovala Azure certifikaci.
* Získávání schváleno prodeji určitého produktu.
* Vytvoření vaši nabídku v portálu pro partnery cloudu. 
...
## <a name="how-do-i-become-azure-certified"></a>Jak stát, certifikaci Azure?
...
Seznam častých dotazů najdete v tématu [Azure Marketplace – nejčastější dotazy](https://azure.microsoft.com/marketplace/faq/).
...
Nyní je čas získat schválení prodávat vašem produkt na webu Marketplace (obrázek 3). Microsoft usnadňuje jmenovat svůj produkt, dokončete proces publikování a zaregistrujte se jako prodejce.
...
Prvním krokem k schválení je [jmenovat](https://createopportunity.azurewebsites.net/) svůj produkt před registrací a publikace. Může trvat schválení _až do tří pracovních dnů_.
...
Tady je několik nástrojů a osvědčené postupy, které vám mohou pomoci co nejlépe využít se prodejce na webu Marketplace.
...
Po zadání jeho kontaktní údaje, můžou zákazníci přistupovat k jednotce předem testu. Dojde k praktických samonaváděcí zkušební verzi produktu & č. 39; s klíčové funkce a výhody ve scénáři reálného.

V současné době publikování test jednotky pro svůj produkt je k dispozici pouze na portálu classic publikování. Další informace tak, že přejdete k dokumentaci [jak publikovat na nový disk testovací](https://github.com/Azure/AzureTestDrive/wiki).

Další informace o [Azure test jednotky](https://azuremarketplace.azureedge.net/documents/azure-marketplace-test-drive-program.pdf).
...
## <a name="what-about-reports"></a>Co o sestavách?

Na webu Marketplace nabízí sestavy ve vaší objednávky, využití a zákazníky, kteří jsou přístupné přes Marketplace [portálu vydavatele Reporting](https://reports.azure.com). Nezpracovaná data kromě užitečné přehledy a analýzy, je uvedený v tabulce navigaci a lze stáhnout jako soubor CSV nebo XLS.

[Toto video](https://player.vimeo.com/video/200859918) vám dává vás zajímá funkce Náhled sestavy funkcí a výhod, jako třeba:

- Typy sestav: Souhrn snímek objednávky, využití a trendy zákazníka na domovské stránce.
...
- Zobrazené jako standard několik přehledy.
...
Podrobné sestavy zobrazit údaje zákazníka, jako je název společnosti a zeměpisnou polohu dolů PSČ, tak můžete porovnat vašich zákazníků. Následující seznam obsahuje konkrétní atributy, které poskytujeme o vašim zákazníkům:
