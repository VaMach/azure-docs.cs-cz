...
> [!NOTE]
> Toto výchozí nastavení NSG není zablokovat přístup k portu, který používá pro zabezpečení protokolu LDAP. Zamknout LDAP zabezpečit přístup přes internet, najdete v části [v tomto článku](active-directory-ds-troubleshoot-ldaps.md).
>
