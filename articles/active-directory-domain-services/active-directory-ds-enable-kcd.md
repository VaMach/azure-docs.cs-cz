...
V systému Windows Server 2012 R2 a Windows Server 2012 umožňuje konfiguraci omezeného delegování pro službu přesunula ze správce domény na správce služeb. Správce služeb back-end tímto způsobem můžete povolit nebo odepřít front-endové služby. Tento model se označuje jako **omezeného delegování kerberos založené na prostředcích**.
