...
* **Synchronizovat účty:** Pokud účty ovlivněného uživatele jsou synchronizované z místního adresáře, ověřte, že:
  ...
  * V závislosti na velikosti adresáře může chvíli trvat, než pro uživatelské účty a přihlašovací údaje, hodnoty hash být k dispozici v Azure AD Domain Services. Zajistěte, že abyste počkali dost dlouho, než se budete pokoušet ověřování (v závislosti na velikosti adresáře - pár hodin za den nebo dvě pro velké adresáře).
