---
title: "Azure Active Directory B2C: Volání webového rozhraní API z aplikace pro iOS přes knihovny třetích stran | Dokumentace Microsoftu"
...
## <a name="download-the-third-party-library-nxoauth2-and-launch-a-workspace"></a>Stáhnutí knihovny třetí strany nxoauth2 a spuštění pracovního prostředí
...
### <a name="adding-the-library-to-your-project-using-cocoapods"></a>Přidání knihovny do projektu pomocí CocoaPods
...
## <a name="create-the-settingsplist-file-for-your-application"></a>Vytvoření souboru `settings.plist` pro aplikaci
...
## <a name="set-up-a-appdata-class-to-read-our-settings"></a>Nastavení třídy AppData tak, aby přečetla naše nastavení
...
## <a name="set-up-the-nxoauth2client-library-in-your-appdelegate"></a>Nastavení knihovny NXOAuth2Client v AppDelegate
...
## <a name="create-a-loginviewcontroller-class-that-we-will-use-to-handle-authentication-requests"></a>Vytvoření třídy `LoginViewController`, kterou použijeme k vyřizování požadavku na ověřování
...
* Vytvořte soubor `GraphAPICaller.m file`
