...
[!code-azurecli-interactive[hlavní](../../../cli_scripts/mysql/scale-mysql-server/scale-mysql-server.sh?highlight=15-16 "vytvořit a škálování Azure Database pro databázi MySQL.")]
...
[!code-azurecli-interactive[hlavní](../../../cli_scripts/mysql/scale-mysql-server/delete-mysql.sh  "Odstraňte skupinu prostředků.")]
