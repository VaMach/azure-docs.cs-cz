...
V závislosti na vaší platformě postupujte podle příslušných pokynů a nainstalujte Node.js. Pomocí npm nainstalujte balíček mysql2 a jeho závislosti do složky vašeho projektu.

### <a name="windows"></a>**Windows**
1. Přejděte na [stránky pro stažení Node.js](https://nodejs.org/en/download/) a vyberte požadovanou možnost Instalační služby systému Windows.
2. Vytvořte místní složku projektu, například `nodejsmysql`. 
3. Spusťte příkazový řádek a pomocí příkazu cd přejděte do složky projektu, například `cd c:\nodejsmysql\`.
...
2. Spusťte příkazový řádek nebo prostředí Bash. Změňte adresář na složku vašeho projektu pomocí příkazu `cd nodejsmysql`.
...
Použijte následující kód k připojení a čtení dat pomocí příkazu **UPDATE** jazyka SQL. 
