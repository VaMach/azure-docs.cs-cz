            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/rest/api/apimanagement/ApiManagementREST/API-Management-REST">Rozhraní API REST (původní)</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize"><p />
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Ostatní</h3>
                        <p><a href="https://msdn.microsoft.com/library/azure/dn894081">Zásady</a></p>
                        <p><a href="https://msdn.microsoft.com/library/azure/mt697540">Šablony</a></p>
                    </div>
                </div>
            </div>
        </div>
