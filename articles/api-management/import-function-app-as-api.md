---
title: "Import funkce aplikace jako rozhraní API pomocí portálu Azure | Microsoft Docs"
description: "V tomto kurzu se dozvíte, jak importovat aplikaci funkce jako rozhraní API pomocí rozhraní API správy (APIM)."
...
---
# <a name="import-a-function-app-as-an-api"></a>Import funkce aplikace jako rozhraní API

Tento článek ukazuje, jak importovat aplikaci funkce jako rozhraní API. Článek také ukazuje, jak otestovat APIM rozhraní API.

V tomto článku se dozvíte, jak:

> [!div class="checklist"]
> * Import funkce aplikace jako rozhraní API
...
+ Ujistěte se, že v rámci vašeho předplatného funkce aplikace. Další informace najdete v tématu [vytvořit aplikaci – funkce](../azure-functions/functions-create-first-azure-function.md#create-a-function-app)
...
2. Vyberte **aplikaci funkce** z **přidání nového rozhraní API** seznamu.

    ![Funkce aplikace](./media/import-function-app-as-api/function-app-api.png)
3. Stiskněte klávesu **Procházet** zobrazíte seznam funkce aplikací ve vašem předplatném.
