...
>[!TIP]
>Vždy, když vytvoříte kontejner systému SQL Server v provozním prostředí, měli byste [změnit heslo správce systému výchozí](https://docs.microsoft.com/sql/linux/quickstart-install-connect-docker.md#change-the-sa-password).
