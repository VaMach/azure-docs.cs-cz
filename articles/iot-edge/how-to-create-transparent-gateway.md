...
[Jak IoT hraniční zařízení lze použít jako brána] [ lnk-edge-as-gateway] článek poskytuje koncepční overviwe jak IoT hraniční zařízení lze použít jako brána transparentní nebo provádět překlad protokolu nebo identity. Tento článek obsahuje podrobné pokyny pro používání IoT hraniční zařízení jako brána transparentní. Pro zbývající část tohoto článku *IoT hraniční brána* je IoT hraniční zařízení používá jako brána transparentní.
