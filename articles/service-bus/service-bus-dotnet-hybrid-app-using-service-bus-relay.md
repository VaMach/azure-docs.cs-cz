...
# Hybridní lokální/cloudová aplikace .NET s předáváním přes Azure Service Bus
...
-   Jak používat předávání přes Azure Service Bus ke sdílení dat mezi aplikací Azure a webovou službou hostovanou jinde.

[AZURE.INCLUDE [create-account-note](../../includes/create-account-note.md)]

## Jak předávání přes Service Bus pomáhá s hybridními řešeními
...
3.  Vaše aplikace by se měla objevit a spustit v prohlížeči.
...
1.  Pokud ve Visual Studiu není otevřený projekt **ProductsPortal**, který jste vytvořili v části „Vytvoření aplikace ASPP.NET“.

2.  Podobně jako v části „Vytvoření lokálního serveru“ do Odkazů projektu přidejte balíček NuGet. V Průzkumníku řešení klikněte pravým tlačítkem na projekt **ProductsPortal**, pak klikněte na **Správa balíčků NuGet**.
...
7.  V Průzkumníku řešení klikněte pravým tlačítkem na projekt **ProductsPortal**, pak klikněte na **Přidat**, pak na **Existující projekt**.
...
### Nastavení ProductsPortal jako webové aplikace
