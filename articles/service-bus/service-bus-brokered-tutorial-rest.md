...
# Kurz REST pro zprostředkované zasílání zpráv ve službě Service Bus
...
1. V hlavním okně [klasický portál Azure][] klikněte na název oboru názvů, který jste vytvořili v předchozím kroku.

1. Klikněte na kartu **Konfigurovat**.

1. V části **generátor sdíleného přístupového klíče** si poznamenejte **Primární klíč** přiřazený k zásadám **RootManagerSharedAccessKey** nebo ho zkopírujte do schránky. Tuto hodnotu použijete později v tomto kurzu.

## Vytvoření konzolového klienta

Fronty služby Service Bus vám umožňují ukládat zprávy do fronty FIFO (first in, fisrt out). Témata a odběry implementují vzorec publikovat/odebírat – vytvoříte téma a pak vytvoříte jeden nebo víc odběrů přiřazených k tomu tématu. Když se do témata odešlou zprávy, okamžitě se odešlou odběratelům tohoto témata.

Kód v tomto kurzu provádí toto:

- Použije váš obor názvů služby a klíč [Sdíleného přístupového podpisu](service-bus-sas-overview.md) (SAS) k získání přístupu k vašim prostředkům oboru názvů služby Service Bus.
...
Jelikož je tato služba webová služba ve stylu REST, nepoužívají se žádné speciální typy, protože se při celé výměně používají řetězce. To znamená, že projekt Visual Studia nesmí odkazovat na žádné knihovny služby Service Bus.

Když v prvním kroku získáte pověření a obor názvů služby, můžete pak ve Visual Studiu vytvořit základní konzolovou aplikaci.
...
## Zaslání zprávy do fronty

V tomto kroku přidáte metodu, která pomocí příkazu HTTP POST ve stypu REST odešle zprávu do fronty, kterou jste vytvořili v předchozím kroku.
...
## Přijetí a odstranění zprávy z fronty
...
### Načtení informačního kanálu Atom se zadanými prostředky
...
### Odstranění entit přenosu zpráv
...
### Formátování informačního kanálu Atom
...
Teď můžete aplikaci sestavit a spustit. V nabídce **Sestavení** ve Visual Studiu klikněte na **Sestavit řešení** nebo stiskněte F6.
...
- [Kurz REST pro předávání přes Service Bus](service-bus-relay-rest-tutorial.md)
