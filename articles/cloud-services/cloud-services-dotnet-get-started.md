<properties
    pageTitle="Začínáme s cloudovými službami službou Azure Cloud Services a technologií ASP.NET | Microsoft Azure"
...
3. Stisknutím kláves CTRL+SHIFT+B řešení sestavíte.
...
3. V **Průzkumníku řešení** zkontrolujte, jestli je jako spouštěný projekt vybraná možnost **ContosoAdsCloudService**.

2. Pokud používáte Visual Studio 2015, změňte připojovací řetězec serveru SQL v aplikačním souboru *Web.config* projektu ContosoAdsWeb a v souboru *ServiceConfiguration.Local.cscfg* projektu ContosoAdsCloudService. V každém případě změňte „(localdb) \v11.0“ na „\MSSQLLocalDB (localdb)“.
...
2. Klikněte na **Vytvořit reklamu**.

2. Zadejte nějaká testovací data, vyberte obrázek *.jpg*, který chcete odeslat, a potom klikněte na **Vytvořit**.
...
3. Chvíli počkejte a potom indexovou stránku aktualizujte. Miniatura se teď zobrazí.

    ![Indexová stránka](./media/cloud-services-dotnet-get-started/list.png)

4. Pokud chcete obrázek reklamy zobrazit v plné velikosti, klikněte na **Podrobnosti**.
...
4. Do vstupního pole adresy URL zadejte předponu adresy URL.
...
6. Klikněte na **Vytvořit cloudovou službu**.
...
1. Do pole **Název databáze** zadejte text *contosoads*.

1. V rozevíracím seznamu **Server** zvolte **Nový server databáze SQL**.

    Pokud vaše předplatné obsahuje server, můžete alternativně vybrat tento server v rozevíracím seznamu.

1. Vyberte stejnou **Oblast** jako pro cloudové služby.
...
1. Zadejte **Přihlašovací jméno** a **Heslo** správce.
...
1. Klikněte na **Vytvořit databázi SQL**.

    ![Nová databáze SQL](./media/cloud-services-dotnet-get-started/newdb.png)

1. Když Azure dokončí vytvoření databáze, klikněte na kartu **Databáze SQL** v levém podokně portálu a potom klikněte na název nové databáze.

2. Klikněte na kartu **Řídicí panel**.

3. Klikněte na **Spravovat povolené IP adresy**.

4. V části **Povolené služby** změňte hodnotu **Služby Azure** na **Ano**.
...
4. Do pole **Adresa URL** zadejte předponu adresy URL.
...
5. V rozevíracím seznamu **Oblast** vyberte stejnou oblast, jakou jste zvolili pro cloudové služby.
...
6. V rozevíracím seznamu **Replikace** vyberte **Místně redundantní**.
...
>[AZURE.NOTE] V této a v další části uložíte přihlašovací údaje do souborů projektu. [Citlivá data neukládejte do veřejných úložišť  zdrojového kódu](http://www.asp.net/aspnet/overview/developing-apps-with-windows-azure/building-real-world-cloud-apps-with-windows-azure/source-control#secrets).
...
4. V transformačním souboru *Web.Release.config* odstraňte text `{connectionstring}` a na jeho místo vložte připojovací řetězec ADO.NET z portálu Azure Classic.

5. V připojovacím řetězci, který jste vložili do transformačního souboru*Web.Release.config*, nahraďte text `{your_password_here}` heslem, které jste vytvořili pro novou databázi SQL.
...
5. V **Průzkumníku řešení** v části **Role** v projektu cloudové služby klikněte pravým tlačítkem na **ContosoAdsWorker** a potom klikněte na **Vlastnosti**.

    ![Vlastnosti rolí](./media/cloud-services-dotnet-get-started/rolepropertiesworker.png)

6. Klikněte na kartu **Nastavení**.

7. Změňte nastavení **Konfigurace služby** na **Cloud**.

7. V nastavení `ContosoAdsDbConnectionString` vyberte pole **Hodnota** a vložte do něj připojovací řetězec, který jste zkopírovali v předchozí části kurzu.
...
7. V dialogovém okně **Změna ověřování** vyberte **Bez ověřování** a potom klikněte na tlačítko **OK**.

    ![Bez ověřování](./media/cloud-services-dotnet-get-started/noauth.png)

8. V dialogovém okně **Nový projekt ASP.NET** klikněte na tlačítko **OK**.

9. V **Průzkumníku řešení** klikněte pravým tlačítkem na řešení (ne na projekt) a zvolte **Přidat – nový projekt**.

11. V dialogovém okně **Přidání nového projektu**  klikněte v levém podokně v části **Visual C#** na tlačítko **Windows** a potom klikněte na šablonu **Knihovna tříd**.  
...
3. V projektu ContosoAdsCommon odstraňte soubor *Class1.cs* a na jeho místo přidejte soubory *Ad.cs* a *ContosoAdscontext.cs* ze staženého projektu.

3. Do projektu ContosoAdsWeb přidejte následující soubory ze staženého projektu.
    - *Global.asax.cs*.  
