...
Máme dvě verze, které jsou k dispozici pro upgrade: 1.8.0 a 1.8.1.  Můžeme použít `az aks upgrade` příkaz pro upgrade na nejnovější dostupnou verzi.  Během procesu upgradu, jsou uzly pečlivě [cordoned a k nečekaně](https://kubernetes.io/docs/tasks/administer-cluster/safely-drain-node/) minimalizovat přerušení spuštěných aplikací.
