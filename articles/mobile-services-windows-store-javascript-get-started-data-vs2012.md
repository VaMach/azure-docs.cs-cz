...
<p>This tutorial adds Mobile Services functionality to a Windows Store app created in Visual Studio 2012. Visual Studio 2013 includes new features that make it easy to connect your Windows Store app to Mobile Services. For more information, see <a href="/zh-cn/develop/mobile/tutorials/get-started-with-data-js/">Get started with data in Mobile Services</a>.</p>
</div>
...
[C# and XAML]: /zh-cn/develop/mobile/tutorials/get-started-with-data-dotnet-vs2012
