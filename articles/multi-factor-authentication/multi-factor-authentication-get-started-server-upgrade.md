...
---
# <a name="upgrading-the-phonefactor-agent-to-azure-multi-factor-authentication-server"></a>Upgrade agenta PhoneFactor na server Azure Multi-Factor Authentication
...
## <a name="to-upgrade-the-phonefactor-agent-to-azure-multi-factor-authentication-server"></a>Postup upgradu agenta PhoneFactor na server Azure Multi-Factor Authentication
<ol>
