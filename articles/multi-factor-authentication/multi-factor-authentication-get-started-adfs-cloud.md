---
title: Zabezpečení cloudových prostředků s Azure Multi-Factor Authentication a AD FS
...
1. Postupujte podle kroků uvedených v [zapnutí ověřování multi-factor authentication](multi-factor-authentication-get-started-cloud.md#turn-on-multi-factor-authentication-for-users) pro uživatele pro povolení účtu.
