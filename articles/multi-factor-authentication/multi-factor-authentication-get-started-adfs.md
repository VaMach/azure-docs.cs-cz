---
title: Začínáme s ověřováním Azure Multi-Factor Authentication a službami Active Directory Federation Services
...
|:--- |:--- |:--- |
| Zabezpečení prostředků Azure AD pomocí Azure Multi-Factor Authentication |<li>1. faktor ověřování se provádí místně pomocí služby AD FS.</li> <li>2. faktor je metoda založená na telefonu prováděná pomocí cloudového ověřování.</li> |
| Zabezpečení prostředků Azure AD pomocí Active Directory Federation Services |<li>1. faktor ověřování se provádí místně pomocí služby AD FS.</li><li>2. faktor je prováděn v místě dodržením deklarace identity.</li> |
