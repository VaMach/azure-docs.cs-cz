---
title: "Začínáme s Azure Multi-Factor Authentication Serverem"
...
---
# <a name="getting-started-with-the-azure-multifactor-authentication-server"></a>Začínáme s Azure Multi-Factor Authentication Serverem
...
## <a name="download-the-azure-multifactor-authentication-server"></a>Stažení Azure Multi-Factor Authentication Serveru
...
### <a name="to-download-the-azure-multifactor-authentication-server-from-the-azure-portal"></a>Stažení serveru Azure Multi-Factor Authentication z portálu Azure
- - -
...
### <a name="to-download-the-azure-multifactor-authentication-server-via-the-service-settings"></a>Stažení Azure Multi-Factor Authentication Serveru přes nastavení služby
1. Přihlaste se do Portálu Azure jako správce.
2. Vlevo vyberte možnost Active Directory.
...
## <a name="install-and-configure-the-azure-multifactor-authentication-server"></a>Instalace a konfigurace Azure Multi-Factor Authentication Serveru
...
### <a name="azure-multifactor-authentication-server-firewall-requirements"></a>Požadavky na firewall pro Azure Multi-Factor Authentication Server
- - -
...
### <a name="to-install-and-configure-the-azure-multifactor-authentication-server"></a>Instalace a konfigurace serveru Azure Multi-Factor Authentication
- - -
...
### <a name="configuring-email-and-email-templates"></a>Konfigurace emailu a šablon e-mailu
...
## <a name="how-the-azure-multifactor-authentication-server-handles-user-data"></a>Jak Azure Multi-Factor Authentication Server nakládá s uživatelskými daty
...
## <a name="advanced-azure-multifactor-authentication-server-configurations"></a>Pokročilá konfigurace Azure Multi-Factor Authentication Serveru
