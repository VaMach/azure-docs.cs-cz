...
### Možnost 1: Stažení Azure Multi-Factor Authentication Serveru z portálu Azure Classic
...
### Možnost 2: Stažení Azure Multi-Factor Authentication Serveru z nastavení služby
