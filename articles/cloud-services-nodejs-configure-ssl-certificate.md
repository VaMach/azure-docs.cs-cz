...
[How to Configure an SSL Certificate on an HTTPS Endpoint]
  ...
  [Configuring SSL for a Node.js Application in an Azure Worker Role]: /zh-cn/develop/nodejs/common-tasks/enable-ssl-worker-role/
