...
2. Zpracujte videa pomocí jedné z následujících služeb Media Analytics:
   ...
   * **Hyperlapse** – [zpracování multimediálních souborů pomocí technologie Azure Media Hyperlapse](media-services-hyperlapse-content.md)
