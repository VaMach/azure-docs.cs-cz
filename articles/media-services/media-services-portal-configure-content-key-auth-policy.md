...
Tento článek ukazuje, jak pomocí portálu Azure a nakonfigurujte zásady autorizace klíče obsahu. Klíč lze později dynamicky šifrovat obsah. Nyní můžete šifrovat formátech streamování: HLS, MPEG DASH a technologie Smooth Streaming. Nelze zašifrovat progresivní stahování.
...
**Otevřete** omezení znamená systému poskytuje klíč pro každý, kdo požádá klíče. Toto omezení může být užitečná pro účely testování.
...
Můžete kliknout na **importovat zásady xml** tlačítko a zadejte jiný kód XML, který vyhovuje na XML schéma definované [zde](media-services-playready-license-template-overview.md).
