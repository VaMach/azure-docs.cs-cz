...
>[AZURE.NOTE]Pokud přidáte nebo aktualizujete zásady pro doručení assetu, musíte odstranit stávající lokátor (pokud existuje) a vytvořit nový.
...
1. Nainstalujte a přidejte sadu Azure Media Services .NET SDK pomocí balíčku NuGet.
2. Přidejte další reference: System.Configuration.
2. Přidejte konfigurační soubor, který obsahuje informace o názvu účtu a klíči:
