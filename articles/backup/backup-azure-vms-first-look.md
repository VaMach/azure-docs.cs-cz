...
3. V průvodci Rychlého vytvoření klikněte na **Datové služby** > **Služby zotavení** > **Trezor záloh** > **Rychle vytvořit**.
...
7. Klikněte na **Vytvořit trezor**. Vytvoření trezoru záloh může chvíli trvat. Sledujte oznámení stavu ve spodní části portálu.
    ...
    Objeví se zpráva s potvrzením, že trezor byl úspěšně vytvořený. Na stránce **Služby zotavení** je označené jako **Aktivní**.

    ![Informační zpráva vytvoření trezoru](./media/backup-azure-vms-first-look/create-vault-demo-success.png)

8. V seznamu trezorů na stránce **Služby zotavení** vyberte vytvořený trezor pro spuštění stránky **Rychlý start**.
...
2. Na portálu Azure Classic klikněte na **Služby zotavení** pro otevření seznamu trezorů Služeb zotavení.
...
8. V místní nabídce **Registrovat položky** vyberte virtuální počítače, které chcete zaregistrovat.
    ...
    >[AZURE.TIP] Najednou může být registrováno více virtuálních počítačů.
...
1. Na portálu Azure Classic přejděte ve **Službách zotavení** do trezoru záloh a klikněte na **Registrované položky**.
...
5. V nabídce **Konfigurace ochrany** vyberte existující zásadu nebo vytvořte novou zásadu k ochraně určených virtuálních počítačů.
    ...
    >[AZURE.NOTE] Zásada zálohování obsahuje schéma uchovávání pro plánované zálohy. Pokud zvolíte existující zásadu zálohování, nebudete moci v dalším kroku změnit možnosti uchovávání.
...
2. Chcete-li zobrazit seznam úloh, klikněte na kartu **Úlohy**.
    ...
    >[AZURE.NOTE] Zálohování virtuálních počítačů je místní proces. Virtuální počítače z jedné oblasti nelze zálohovat do trezoru záloh v jiné oblasti. Pro každou oblast Azure s virtuálními počítači, které je třeba zálohovat, je tedy nutné vytvořit v této oblasti alespoň jeden trezor záloh.
