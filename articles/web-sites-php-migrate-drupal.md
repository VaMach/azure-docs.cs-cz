...
- [Azure Blob Storage Module](https://drupal.org/project/azure_blob)
  ...
  [Create a PHP-MySQL Azure web site and deploy using Git]: http://azure.microsoft.com/zh-cn/documentation/articles/web-sites-php-mysql-deploy-use-git/
  ...
  [Azure Web Sites, Cloud Services, and VMs: When to use which?]: http://azure.microsoft.com/zh-cn/documentation/articles/choose-web-site-cloud-service-vm/
