...
### [Rozhraní příkazového řádku](dns-getstarted-create-dnszone-cli.md)
...
### [Rozhraní příkazového řádku](dns-operations-recordsets-cli.md)

## [Správa reverzních záznamů DNS](dns-reverse-dns-record-operations-ps.md)
### [Rozhraní příkazového řádku](dns-reverse-dns-record-operations-cli.md)
