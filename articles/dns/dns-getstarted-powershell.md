...
Tento článek vás provede kroky k vytvoření první zóny a záznamu DNS pomocí Azure PowerShellu. Tyto kroky můžete provést také pomocí webu Azure Portal nebo Azure CLI pro různé platformy.
