...
The following is a PowerShell script for getting the MapReduce jobtracker information:
	...
	$ambariUri = "https://$clusterName.hdinsightservices.cn:443/ambari"
	$uriJobTracker = "$ambariUri/api/v1/clusters/$clusterName.hdinsightservices.cn/services/mapreduce/components/jobtracker"
...
The following is an example of getting cluster information using Curl:
	...
	curl -u <username>:<password> -k https://<ClusterName>.hdinsightservices.cn:443/ambari/api/v1/clusters/<ClusterName>.hdinsightservices.cn

The output is:
	
	{"href":"https://hdi0211v2.hdinsightservices.cn/ambari/api/v1/clusters/hdi0211v2.hdinsightservices.cn/",
	 "Clusters":{"cluster_name":"hdi0211v2.hdinsightservices.cn","version":"2.1.3.0.432823"},
	 "services"[
	   {"href":"https://hdi0211v2.hdinsightservices.cn/ambari/api/v1/clusters/hdi0211v2.hdinsightservices.cn/services/hdfs",
	    "ServiceInfo":{"cluster_name":"hdi0211v2.hdinsightservices.cn","service_name":"hdfs"}},
	   {"href":"https://hdi0211v2.hdinsightservices.cn/ambari/api/v1/clusters/hdi0211v2.hdinsightservices.cn/services/mapreduce",
	    "ServiceInfo":{"cluster_name":"hdi0211v2.hdinsightservices.cn","service_name":"mapreduce"}}],
	 "hosts":[
	   {"href":"https://hdi0211v2.hdinsightservices.cn/ambari/api/v1/clusters/hdi0211v2.hdinsightservices.cn/hosts/headnode0",
	    "Hosts":{"cluster_name":"hdi0211v2.hdinsightservices.cn",
	             "host_name":"headnode0"}},
	   {"href":"https://hdi0211v2.hdinsightservices.cn/ambari/api/v1/clusters/hdi0211v2.hdinsightservices.cn/hosts/workernode0",
	    "Hosts":{"cluster_name":"hdi0211v2.hdinsightservices.cn",
...
<tr><td>Get cluster info.</td><td>/api/v1/clusters/&lt;ClusterName&gt;.hdinsightservices.cn</td><td>clusters, services, hosts</td></tr>
<tr><td>Get services</td><td>/api/v1/clusters/&lt;ClusterName&gt;.hdinsightservices.cn/services</td><td>Services include: hdfs, mapreduce</td></tr>
<tr><td>Get services info.</td><td>/api/v1/clusters/&lt;ClusterName&gt;.hdinsightservices.cn/services/&lt;ServiceName&gt;</td><td></td></tr>
<tr><td>Get service components</td><td>/api/v1/clusters/&lt;ClusterName&gt;.hdinsightservices.cn/services/&lt;ServiceName&gt;/components</td><td>HDFS: namenode, datanode<br/>MapReduce: jobtracker; tasktracker</td></tr>
<tr><td>Get component info.</td><td>/api/v1/clusters/&lt;ClusterName&gt;.hdinsightservices.cn/services/&lt;ServiceName&gt;/components/&lt;ComponentName&gt;</td><td>ServiceComponentInfo, host-components, metrics</td></tr>
<tr><td>Get hosts</td><td>/api/v1/clusters/&lt;ClusterName&gt;.hdinsightservices.cn/hosts</td><td>headnode0, workernode0</td></tr>
<tr><td>Get host info.</td><td>/api/v1/clusters/&lt;ClusterName&gt;.hdinsightservices.cn/hosts/&lt;HostName&gt; 
</td><td></td></tr>
<tr><td>Get host components</td><td>/api/v1/clusters/&lt;ClusterName&gt;.hdinsightservices.cn/hosts/&lt;HostName&gt;/host_components
</td><td>namenode, resourcemanager</td></tr>
<tr><td>Get host component info.</td><td>/api/v1/clusters/&lt;ClusterName&gt;.hdinsightservices.cn/hosts/&lt;HostName&gt;/host_components/&lt;ComponentName&gt;
</td><td>HostRoles, component, host, metrics</td></tr>
<tr><td>Get configurations</td><td>/api/v1/clusters/&lt;ClusterName&gt;.hdinsightservices.cn/configurations 
</td><td>Config types: core-site, hdfs-site, mapred-site, hive-site</td></tr>
<tr><td>Get configuration info.</td><td>/api/v1/clusters/&lt;ClusterName&gt;.hdinsightservices.cn/configurations?type=&lt;ConfigType&gt;&tag=&lt;VersionName&gt; 
</td><td>Config types: core-site, hdfs-site, mapred-site, hive-site</td></tr>
</table>
