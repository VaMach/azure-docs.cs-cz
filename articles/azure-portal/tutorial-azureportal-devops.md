...
* Další informace o nasazování do Azure App Service najdete v tématu [Nasazení vaší aplikace do Azure App Service](../app-service/app-service-deploy-local-git.md)
