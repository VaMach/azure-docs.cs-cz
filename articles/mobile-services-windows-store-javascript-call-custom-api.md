...
[Define a custom API that supports periodic notifications]: /zh-cn/documentation/articles/mobile-services-windows-store-javascript-create-pull-notifications
