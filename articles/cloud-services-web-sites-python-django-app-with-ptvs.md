...
Another option would be to create a Virtual Machine and install a database server.  See instructions [here](http://www.windowsazure.com/zh-cn/manage/linux/common-tasks/mysql-on-a-linux-vm/) for setting up MySQL on an Azure Linux VM.
...
- [Web Site](http://www.windowsazure.com/zh-cn/services/web-sites/)
- [Cloud Service](http://www.windowsazure.com/zh-cn/services/cloud-services/)
- [Virtual Machine](http://www.windowsazure.com/zh-cn/services/virtual-machines/)
...
1. You'll need to import your Azure subscription file.  Click the [Sign in to download credentials](https://manage.windowsazure.cn/publishsettings/index?client=vs&schemaversion=2.0) link to download it from the Azure portal.
