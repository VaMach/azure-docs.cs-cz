<properties
 pageTitle="Předkonfigurované řešení prediktivní údržby | Microsoft Azure"
...
> [AZURE.NOTE] Model řešení využívá data o opotřebení ze skutečných motorů.
...
## Jak je sestaveno řešení prediktivní údržby
...
*\[1\] A. Saxena a Goebel K. (2008). „Turbofan Engine Degradation Simulation Data Set“, datové úložiště NASA Ames Prognostics Data Repository (http://ti.arc.nasa.gov/tech/dash/pcoe/prognostic-data-repository/), NASA Ames Research Center, Moffett Field, CA*
...
Můžete také prozkoumat některé další funkce a možnosti předkonfigurovaných řešení sady IoT Suite:
