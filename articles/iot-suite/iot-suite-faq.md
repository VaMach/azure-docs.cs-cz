---
title: Nejčastější dotazy ke službě Azure IoT Suite | Microsoft Docs
...
1. QueryKey pro rozhraní API Map Bing pro podniky získáte na [portálu Azure][lnk-azure-portal]: 
   ...
   3. Můžete si všimnout dvou klíčů: MasterKey a QueryKey. Zkopírujte hodnotu pro QueryKey.
      ...
      > [!NOTE]
      > Nemáte účet rozhraní API Map Bing pro podniky? Vytvořte si ho na [portálu Azure][lnk-azure-portal] tím, že kliknete na + Nové, vyhledáte rozhraní API Map Bing pro podniky a budete postupovat podle pokynů pro vytvoření.
      > 
      > 
