...
<ol start="3">
<li><p>In Xcode, open the project that you created when you completed the tutorial <a href="/zh-cn/documentation/articles/mobile-services-ios-get-started">Get started with Mobile Services</a>.</p></li> 
...
[Single sign-on for Windows Store apps by using Live Connect]: /zh-cn/develop/mobile/tutorials/single-sign-on-windows-8-dotnet
[Get started with Mobile Services]: /zh-cn/develop/mobile/tutorials/get-started-ios
[Get started with data]: /zh-cn/develop/mobile/tutorials/get-started-with-data-ios
[Get started with authentication]: /zh-cn/develop/mobile/tutorials/get-started-with-users-ios
[Get started with push notifications]: /zh-cn/develop/mobile/tutorials/get-started-with-push-ios
[Authorize users with scripts]: /zh-cn/develop/mobile/tutorials/authorize-users-in-scripts-ios
