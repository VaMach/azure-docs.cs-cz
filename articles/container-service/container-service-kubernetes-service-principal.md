...
Pokud vytváříte cluster Kubernetes spuštěním příkazu [`az acs create`](https://docs.microsoft.com/en-us/cli/azure/acs#create), máte možnost instanční objekt vygenerovat automaticky.
