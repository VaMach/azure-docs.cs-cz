...
* **ID a tajný klíč klienta instančního objektu** (pouze Kubernetes): Další informace a pokyny k vytvoření instančního objektu služby Azure Active Directory najdete v tématu [O instančním objektu pro cluster Kubernetes](../kubernetes/container-service-kubernetes-service-principal.md).
