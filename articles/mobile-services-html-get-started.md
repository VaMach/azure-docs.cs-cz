...
<!--<div class="dev-center-tutorial-subselector">
	<a href="/zh-cn/documentation/articles/mobile-services-dotnet-backend-html-get-started/" title=".NET backend">.NET backend</a> | 
	<a href="/zh-cn/documentation/articles/mobile-services-html-get-started/"  title="JavaScript backend" class="current">JavaScript backend</a>
</div>-->
...
[Call a custom API from an HTML application]: /zh-cn/documentation/articles/mobile-services-html-call-custom-api 
