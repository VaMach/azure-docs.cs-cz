...
V tomto kurzu se dozvíte, jak zabezpečit webové aplikace prostřednictvím zakoupení certifikátu SSL pro vaše  **[Azure App Service](http://go.microsoft.com/fwlink/?LinkId=529714)**, bezpečně uložením do [Azure Key Vault](https://docs.microsoft.com/en-us/azure/key-vault/key-vault-whatis), a přiřadí se mu vlastní doménu.
