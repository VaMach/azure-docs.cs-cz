...
[!code-powershell[hlavní](../../../powershell_scripts/app-service/deploy-local-git/deploy-local-git.ps1?highlight=1 "vytvoření webové aplikace a nasazení kódu z místního úložiště Git")]
