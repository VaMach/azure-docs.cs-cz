...
| [Konfigurace protokolu az webapp](https://docs.microsoft.com/cli/azure/webapp/log#az_webapp_log_config) | Nakonfiguruje protokoly, které se uchová webové aplikace Azure. |
| [AZ webapp protokolu stahování](https://docs.microsoft.com/cli/azure/webapp/log#az_webapp_log_download) | Soubory ke stažení do protokolů webové aplikace Azure do místního počítače. |
