...
Tento ukázkový skript vytvoří skupinu prostředků, plán služby app service a webové aplikace a nakonfiguruje webové aplikaci, která umožní protokolů webového serveru. Pak stáhne soubory protokolů ke kontrole.
...
| [`az webapp log config`](/cli/azure/webapp/log?view=azure-cli-latest#az_webapp_log_config) | Nakonfiguruje protokoly, které webové aplikace Azure přetrvává. |
| [`az webapp log download`](/cli/azure/webapp/log?view=azure-cli-latest#az_webapp_log_download) | Stáhne do protokolů webové aplikace Azure do místního počítače. |
