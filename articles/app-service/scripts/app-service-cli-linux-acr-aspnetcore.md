...
Tento ukázkový skript vytvoří skupinu prostředků, plán služby App Service pro Linux a webové aplikace. Pak nasadí aplikaci ASP.NET Core pomocí kontejner Docker z registru kontejner Azure.
