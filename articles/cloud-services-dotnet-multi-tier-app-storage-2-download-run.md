...
You can create a [free trial account](/zh-cn/pricing/free-trial/) or [activate MSDN subscriber benefits](/zh-cn/pricing/member-offers/msdn-benefits/).
...
For more information on the configuration files, see [Configuring an Azure Project ](http://msdn.microsoft.com/zh-cn/library/windowsazure/ee405486.aspx)
...
1. Follow the instructions in [How to Send Email Using SendGrid with Azure](http://www.windowsazure.com/zh-cn/develop/net/how-to-guides/sendgrid-email-service/ "SendGrid") to sign up for a free account.
...
<div><a href="/zh-cn/develop/net/tutorials/multi-tier-web-site/3-web-role/" class="site-arrowboxcta download-cta">Tutorial 3</a></div>
...
[firsttutorial]: /zh-cn/develop/net/tutorials/multi-tier-web-site/1-overview/
...
[NewPortal]: http://manage.windowsazure.cn
[managestorage]: /zh-cn/manage/services/storage/how-to-manage-a-storage-account/
