...
[!code-powershell[hlavní](../../../powershell_scripts/cosmosdb/get-mongodb-connection-string/get-mongodb-connection-string.ps1?highlight=37-41 "získat připojovací řetězec MongoDB z účtu Azure Cosmos DB")]
