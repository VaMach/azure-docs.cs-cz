...
| [AZ cosmosdb seznamu klíčů](https://docs.microsoft.com/cli/azure/cosmosdb#az_cosmosdb_list_keys) | Vytvoří logického serveru, který je hostitelem databáze SQL. |
