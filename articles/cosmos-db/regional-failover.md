...
Pokud oblasti ovlivněných aktuální oblasti zápis pro daný účet Cosmos DB, pak oblasti budou automaticky označeny jako offline. Oblast alternativní se poté vyzval, jako je zápis oblast každý účet Cosmos DB. Plnou kontrolu nad pořadí výběru oblast pro vaše účty Cosmos DB prostřednictvím portálu Azure nebo [prostřednictvím kódu programu](https://docs.microsoft.com/rest/api/documentdbresourceprovider/databaseaccounts#DatabaseAccounts_FailoverPriorityChange). 

![Priorit převzetí služeb při selhání pro Azure Cosmos DB](./media/regional-failover/failover-priorities.png)

Při automatické převzetí služeb při selhání Cosmos DB automaticky zvolí další zápisu oblast pro daný účet Cosmos DB podle pořadí priority zadané. 
...
* Účty cosmos DB s jejich předchozí oblast zápisu v oblasti ovlivněných zůstanou v offline režimu s dostupností pro čtení i po obnovení oblasti. 
* Můžete dotazovat této oblasti k výpočtu zápisu všech nereplikovaných zápisu během výpadku porovnáním s daty, které jsou k dispozici v aktuální oblasti. Podle potřeb vaší aplikace, můžete provést sloučení nebo konflikt překladu a zapsat poslední sadu změn zpět do aktuální oblasti zápisu. 
* Po dokončení sloučení změn, přepnete zpět do režimu online oblasti ovlivněných odebráním a nové přidání oblasti ke svému účtu Cosmos DB. Jakmile oblast je znovu přidal, můžete ho nakonfigurovat zpět jako oblasti zápisu provedením ruční převzetí služeb při selhání prostřednictvím portálu Azure nebo [prostřednictvím kódu programu](https://docs.microsoft.com/rest/api/documentdbresourceprovider/databaseaccounts#DatabaseAccounts_CreateOrUpdate).
