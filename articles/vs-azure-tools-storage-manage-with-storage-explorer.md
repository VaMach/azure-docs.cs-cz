...
> [!NOTE]
> Můžete zadat připojovací řetězec úložiště z účtu úložiště v národním Azure. Pokud se například chcete připojit k účtům úložiště Azure Black Forest, zadejte připojovací řetězce podobné těmto: DefaultEndpointsProtocol=https;AccountName=cawatest03;AccountKey=<klíč_účtu_úložiště>;EndpointSuffix=core.cloudapi.de. Připojovací řetězec můžete získat z webu Azure Portal stejným způsobem, jaký je popsaný v části **Získání přihlašovacích údajů účtu úložiště**.
