...
The [Azure SDK for PHP] consists of several components. This article will use to of them: Azure PowerShell and the Azure Emulators. These two components can be installed via the Microsoft Web Platform Installer here: [Install Azure PowerShell and the Azure Emulators][install ps and emulators].
...
[execution model-web sites]: /zh-cn/develop/net/fundamentals/compute/#WebSites
[execution model-vms]: /zh-cn/develop/net/fundamentals/compute/#VMachine
[execution model-cloud services]: /zh-cn/develop/net/fundamentals/compute/#CloudServices
...
[What is a Cloud Service?]: /zh-cn/manage/services/cloud-services/what-is-a-cloud-service/
...
[How to: Import publish settings]: /zh-cn/develop/php/how-to-guides/powershell-cmdlets/#ImportPubSettings
[How to: Deploy a cloud service to Azure]: /zh-cn/develop/php/how-to-guides/powershell-cmdlets/#Deploy
