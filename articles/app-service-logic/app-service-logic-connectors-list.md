---
title: "Seznam dostupných konektorů a aplikací API | Dokumentace Microsoftu"
...
---
# <a name="list-of-connectors-and-api-apps-to-use-in-your-logic-apps"></a>Seznam konektorů a aplikací API k použití ve vašich Logic Apps
> [!NOTE]
...
## <a name="core-connectors"></a>Základní konektory
...
## <a name="enterprise-integration-connectors"></a>Konektory pro integraci ve velkých firmách
...
| Název | Popis |
| --- | --- |
| [Pravidla BizTalk](app-service-logic-use-biztalk-rules.md) |Pomocí BizTalk Rules můžete definovat a řídit obchodní logiky v rámci organizace. Firemní zásady můžete aktualizovat bez nutnosti rekompilace nebo opětovného nasazení přidružených aplikací. |
...
## <a name="create-your-own-connectors-and-api-apps"></a>Vytvoření vlastních konektorů a aplikací API
[Referenční informace ke konektorům a API Apps](http://aka.ms/appservicesconnectorreference)  
...
## <a name="more-on-connectors-and-api-apps"></a>Další informace o konektorech a aplikacích API
[Co jsou konektory a API Apps pro BizTalk](app-service-logic-what-are-biztalk-api-apps.md)  
[Použití Správce hybridního připojení v Azure App Service](app-service-logic-hybrid-connection-manager.md)  
[Správa a monitorování integrovaných API Apps a konektorů](app-service-logic-monitor-your-connectors.md)
