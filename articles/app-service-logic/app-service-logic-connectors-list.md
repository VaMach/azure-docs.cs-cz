...
>[AZURE.NOTE] Tato verze článku se vztahuje na verzi schématu Logic Apps ve verzi 2014-12-01-preview. Informace k Logic Apps v obecně dostupné (GA) verzi najdete v tématu [Nový seznam konektorů](../connectors/apis-list.md).
