...
Při vytváření účtu Batch, můžete zadat, kde by měla být pro tento účet vytvořit fondy přidělená. Můžete přidělit fondy v předplatném služby Batch výchozí nebo v předplatném uživatele. Svou volbu ovlivňuje způsob ověření přístupu k prostředkům v daném účtu.
...
- **Předplatné uživatele.** Můžete přidělit fondy Batch v předplatném uživatele, který určíte. Pokud zvolíte tuto možnost, je třeba ověřit pomocí služby Azure AD.
