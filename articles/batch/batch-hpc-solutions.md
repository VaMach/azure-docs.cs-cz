...
>[AZURE.NOTE] Využijte výhod výpočetně náročných instancí Azure ke zlepšení výkonu a škálovatelnosti úloh prostředí HPC, včetně paralelních aplikací MPI, které vyžadují nízkou latenci a vysokou propustnost aplikační sítě. Viz téma [O virtuálních počítačích řady H-series a A-series pro náročné výpočty](../virtual-machines/virtual-machines-windows-a8-a9-a10-a11-specs.md).  
