<properties
   ...
   description="Další informace o scénářích a možnostech řešení pro dávky (batch) a vysokovýkonné výpočetní prostředí (HPC a Big Compute) ve službě Azure"
...
>[AZURE.NOTE] Využijte výhod výpočetně náročných instancí Azure ke zlepšení výkonu některých úloh prostředí HPC, včetně paralelních aplikací MPI, které vyžadují nízkou latenci a vysokou propustnost aplikační sítě. Přečtěte si více [o instancích A8, A9, A10 a A11 náročných na výpočetní výkon](../virtual-machines/virtual-machines-windows-a8-a9-a10-a11-specs.md).  
...
* [Virtual Network](https://azure.microsoft.com/documentation/services/virtual-network/) – vytvoří logicky izolovaný oddíl ve službě Azure, který slouží k vzájemnému připojení prostředků Azure k místnímu datovému centru. Umožňuje aplikacím Big Compute přístup k místním datům, službám Active Directory a licenčním serverům
