...
## Další kroky
Teď, když jste se s SQL Data Warehouse seznámili, můžete zjistit, jak rychle [vytvořit SQL Data Warehouse][vytvořit SQL Data Warehouse] a [načíst ukázková data][načíst ukázková data].
