...
* **Azure Data Factory:** Azure Data Factory dokončí vlastní operaci načtení, takže je nutné mít ji, abyste ji mohli použít k vytvoření kanálu pro přenos dat. Pokud ji ještě nemáte, zjistěte, jak si ji vytvořit (v kroku 1 tématu [Začínáme s Azure Data Factory (Data Factory Editor)][Začínáme s Azure Data Factory (Data Factory Editor)]).
...
* [Studijní postup Azure Data Factory][Studijní postup Azure Data Factory].
* [Azure SQL Data Warehouse Connector][Azure SQL Data Warehouse Connector]. Toto je základní referenční téma pro používání služby Azure Data Factory se službou Azure SQL Data Warehouse.
...
* [Kurz: Kopírování dat z Azure Blob Storage do Azure SQL Database][Kurz: Kopírování dat z Azure Blob Storage do Azure SQL Database]. V tomto kurzu vytvoříte kanál v Azure Data Factory ke zkopírování dat z Azure Blob Storage do Azure SQL Database.
