---
title: Začínáme s Mobile Services pro Xamarin.Android | Microsoft Docs
writer: craigd
...
3. Stiskněte tlačítko **Spustit** a sestavte projekt a spusťte aplikaci. Budete požádáni o výběr emulátoru nebo připojeného zařízení USB.
   ...
   > [!NOTE]
   > Abyste mohli spustit projekt v Android emulátoru, musíte definovat alespoň jedno virtuální zařízení Android (AVD). Použijte správce AVD k vytvoření a správě těchto zařízení.
   > 
   > 
