---
title: Začínáme používat Azure Mobile Services pro aplikace iOS | Microsoft Docs
...
4. V části **Stažení a spuštění aplikace** klikněte na tlačítko **Stáhnout**. Tato akce stáhne projekt pro vzorovou aplikaci *Seznam úkolů*, která je připojena k mobilní službě společně s Mobile Services iOS SDK. Uložte komprimovaný soubor projektu do místního počítače a poznamenejte si, kam jste jej uložili.
