...
CORS můžete pro aplikaci API nakonfigurovat také pomocí [šablon Azure Resource Manageru](../azure-resource-manager/resource-group-authoring-templates.md) v nástrojích příkazového řádku, jako je [Azure PowerShell](/powershell/azureps-cmdlets-docs) nebo [Azure CLI](../cli-install-nodejs.md). 
