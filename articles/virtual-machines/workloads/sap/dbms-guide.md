...
Aby se kombinovat až věcí mezi tři různé typy záloh se doporučuje vytvořit různé kontejnery pod účet úložiště pro zálohy. Kontejnery může být pouze virtuální počítač nebo podle typu virtuálního počítače a zálohování. Schéma může vypadat podobně jako:
...
Podrobnější diskuzi o zálohování a SAP v Azure, najdete v části [příručce zálohování SAP](sap-hana-backup-guide.md) Další informace.
...
Výjimka může být dočasná databáze obsahující všechny pracovní tabulky a dočasných tabulek vytvořili pomocným SAP, který v případě některých ERP SAP a všechny úlohy BW může vyžadovat vyšší datový svazek nebo vstupně-výstupních operací operations svazku, který se nevejde do původní virtuální počítač, disk operačního systému (jednotka c:\).
