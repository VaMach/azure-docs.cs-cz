...
Pokud používáte [portál Azure Classic](https://manage.windowsazure.com/), vyžaduje se pro klíče SSH soubor .pem certifikátu X.509.  Jiné typy veřejných klíčů SSH nejsou povolené, *musí* jít o certifikáty X.509.
...
Pokud používáte model nasazení Azure Classic (režim `asm` v rozhraní příkazového řádku), můžete v kontejneru PEM použít veřejný klíč SSH-RSA nebo klíč ve formátu RFC4716.  Veřejný klíč SSH-RSA byl vytvořen v předchozí části tohoto článku příkazem `ssh-keygen`.
