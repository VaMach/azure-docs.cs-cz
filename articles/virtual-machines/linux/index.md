---
title: "Dokumentace k virtuálním počítačům Azure s Linuxem – kurzy, reference k rozhraní API | Dokumentace Microsoftu"
...
---
<div class="content">
    <h1>Virtuální počítače s Linuxem</h1>
    <div class="introHolder" style="justify-content: space-between;">
        <div class="intro" style="min-width: 200px">
            <p>Virtuální počítače s Linuxem v Azure poskytují vysoce škálovatelnou zabezpečenou virtualizovanou infrastrukturu na vyžádání s využitím Red Hatu, Ubuntu nebo linuxové distribuce podle vaší volby. Naučte se vytvářet, konfigurovat, spravovat a škálovat linuxové virtuální počítače prostřednictvím našich šablon Rychlý start, výukových kurzů a ukázek.</p>
        </div>
        <a href="https://azure.microsoft.com/en-us/resources/videos/create-linux-virtual-machine/">
            <div class="calloutHolder" style="max-width: 250px">
                ...
                <div>
                    <p style="margin-top: 0; color: #6e6e6e">Vytvoření virtuálního počítače s Linuxem (4:11)</p>
                </div>
            </div>
        </a>
    </div>
<h2 style="margin-top: 0px; margin-bottom: 0px;">Zprovoznění během 5 minut</h2>
<p style="margin-top: 6px; margin-bottom: 6px;">Podívejte se, jak nasadit webový server NGINX ve virtuálním počítači se systémem Ubuntu:</p>
<div class="ico48Case">
    <div class="ico48Link">
...
<p>Jak nasadit, spravovat a škálovat virtuální počítače s Linuxem v Azure</p>
<ol>
    <li><a href="/azure/virtual-machines/linux/tutorial-manage-vm">Vytvoření a správa virtuálních počítačů s Linuxem</a></li>
    <li><a href="/azure/virtual-machines/linux/tutorial-manage-disks">Vytvoření a správa disků virtuálního počítače</a></li>
    <li><a href="/azure/virtual-machines/linux/tutorial-automate-vm-deployment">Automatizace konfigurace virtuálních počítačů</a></li>
    <li><a href="/azure/virtual-machines/linux/tutorial-custom-images">Vytváření vlastních imagí virtuálních počítačů</a></li>
    <li><a href="/azure/virtual-machines/linux/tutorial-availability-sets">Vytvoření vysoce dostupných virtuálních počítačů</a></li>
    <li><a href="/azure/virtual-machines/linux/tutorial-create-vmss">Vytvoření škálovací sady virtuálních počítačů</a></li>
    <li><a href="/azure/virtual-machines/linux/tutorial-load-balancer">Vyrovnávání zatížení virtuálních počítačů</a></li>
    <li><a href="/azure/virtual-machines/linux/tutorial-virtual-network">Správa sítě virtuálních počítačů</a></li>
</ol>
