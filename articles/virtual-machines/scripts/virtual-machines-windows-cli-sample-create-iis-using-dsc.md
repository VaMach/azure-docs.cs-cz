...
| [nastavení rozšíření virtuálního az](https://docs.microsoft.com/cli/azure/vm#az_vm_create) | Přidejte do virtuálního počítače, které vyvolá skript k instalaci IIS rozšíření vlastních skriptů. |
