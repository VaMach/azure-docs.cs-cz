...
Pro zabezpečení webové servery, certifikát později SSL (Secure Sockets) slouží k šifrování webový provoz. Tyto certifikáty SSL můžou být uložená v Azure Key Vault a povolit zabezpečená nasazení certifikátů na virtuálních počítačích (VM) s Windows v Azure. V tomto kurzu se naučíte:
