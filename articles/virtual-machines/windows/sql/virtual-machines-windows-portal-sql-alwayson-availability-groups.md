...
7. **Vzdálená plocha** může varovat, že vzdáleného počítače nelze ověřit z důvodu problémů s certifikátem zabezpečení. Zobrazuje jste název certifikátu zabezpečení. Pokud jste postupovali podle kurzu, je název **sqlserver 0.contoso.com**. Klikněte na **Ano**.
