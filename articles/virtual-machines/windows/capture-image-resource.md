...
Pokud chcete vytvořit bitovou kopii disku operačního systému, můžete také crate obrázku tak, že zadáte ID spravovaného disku jako disk operačního systému.
