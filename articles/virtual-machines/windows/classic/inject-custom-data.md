...
---
# <a name="injecting-custom-data-into-an-azure-virtual-machine"></a>Vložení vlastní data do virtuálního počítače Azure
> [!IMPORTANT] 
> Azure má dva různé modely nasazení pro vytváření a práci s prostředky: [Resource Manager a klasický](../../../resource-manager-deployment-model.md). Tento článek se zabývá pomocí modelu nasazení Classic. Microsoft doporučuje, aby byl ve většině nových nasazení použit model Resource Manager. Informace o rozšíření vlastních skriptů pomocí modelu Resource Manager najdete v tématu [zde](../extensions-customscript.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
