...
If you have already installed the <strong>Azure SDK for Node.js</strong> from the <a href="/zh-cn/develop/nodejs/">Azure Developer Center</a>, then the command-line tools should already be installed. For more information, see <a href="/zh-cn/develop/nodejs/how-to-guides/command-line-tools/">Azure command-line tool for Mac and Linux</a>.
...
[Node.js Web Application with Storage on MongoDB (Virtual Machine)]: /zh-cn/develop/nodejs/tutorials/website-with-mongodb-(mac)/
