...
## [Node.js (zařízení)](https://docs.microsoft.com/en-us/javascript/api/azure-iot-device/)
## [Node.js (služba)](https://docs.microsoft.com/en-us/javascript/api/azure-iothub)
