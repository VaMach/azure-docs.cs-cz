...
Za druhé byste pro zajištění, že se aplikace doručuje správným účastníkům, mohli požadovat cílení pomocí [tagování](notification-hubs-routing-tag-expressions.md).
