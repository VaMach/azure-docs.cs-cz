...
1. Klientská aplikace kontaktuje systém oznámení platformy a načte si jeho *popisovač*. Typ popisovače závisí na systému. U WNS je to identifikátor URI nebo „kanál pro oznámení“. U APNS jde o token.
2. Klientská aplikace si tento popisovač uloží v *back-endu* aplikace pro pozdější použití. U WNS je back-endem obvykle cloudová služba. U Applu se tento systém označuje jako *„provider“*.
