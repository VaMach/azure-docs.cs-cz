...
Příjem oznámení můžete otestovat ve vaší aplikaci odesláním nabízených oznámení na [portálu Azure] prostřednictvím části **Poradce při potížích** v okně centra (použijte možnost *Testovací odeslání*).
...
2. Můžete odeslat testovací nabízená oznámení z [portálu Azure], jak je popsáno výše. Pokud jste přidali kód pro odesílání nabízených oznámení v aplikaci, klepněte do textového pole a zadejte zprávu oznámení. Pak stiskněte tlačítko **Odeslat** na klávesnici nebo tlačítko **Odeslat oznámení** v zobrazení k odeslání zprávy oznámení.
...
Obecné informace o centrech oznámení naleznete v tématu [Pokyny centra oznámení].
