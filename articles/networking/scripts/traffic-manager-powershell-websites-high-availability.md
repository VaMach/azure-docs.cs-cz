...
[!code-powershell[hlavní](../../../powershell_scripts/traffic-manager/direct-traffic-for-increased-application-availability/direct-traffic-for-increased-application-availability.ps1 "směrování provozu pro zajištění vysoké dostupnosti")]
