...
[!code-azurecli-interactive[hlavní](../../../cli_scripts/virtual-network/virtual-network-multi-tier-application/virtual-network-multi-tier-application.sh  "virtuální sítě pro vícevrstvé aplikace")]
