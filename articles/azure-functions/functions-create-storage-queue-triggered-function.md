...
Před spuštěním této ukázky musíte provést následující:
...
Rozbalte aplikaci Function App, klikněte na tlačítko **+** vedle možnosti **Funkce** a klikněte na šablonu **QueueTrigger** pro požadovaný jazyk. Potom použijte nastavení uvedené v tabulce a klikněte na **Vytvořit**.
...
1. Spusťte nástroj [Microsoft Azure Storage Explorer](http://storageexplorer.com/), vlevo klikněte na ikonu připojení, zvolte **Použít název a klíč účtu úložiště** a klikněte na **Další**.
...
1. V Průzkumníku úložiště rozbalte svůj účet úložiště, možnosti **Fronty**, a **myqueue-items** a potom klikněte na **Přidat zprávu**.
...
1. Zpátky v Průzkumníku úložiště klikněte na **Aktualizovat** a zkontrolujte, jestli proběhlo zpracování zprávy a jestli zpráva zmizela z fronty.
