...
* **Licencování (Služba správy klíčů):** Bitové kopie systému Windows spuštěné ve virtuálních počítačích musí být licencované. Aby se zajistilo licencování, odesílají se žádosti o licenci na hostitelské servery Služby správy klíčů, které takové dotazy zpracovávají. Požadavek odchází přes port 1688.
...
4. Z internetu není přístup k virtuálním počítačům front-end ani back-end s výjimkou požadavků 1 a 3.
