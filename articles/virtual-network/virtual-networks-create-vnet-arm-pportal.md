...
Tento dokument popisuje vytvoření virtuální sítě pomocí modelu nasazení Resource Manager. Můžete také [vytvořit virtuální síť v klasickém modelu nasazení pomocí portálu Azure Preview](virtual-networks-create-vnet-classic-pportal.md).
