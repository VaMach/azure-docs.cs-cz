...
1. Přihlaste se k portálu [Azure Portal](<https://portal.azure.com>). Pokud ještě účet nemáte, můžete si zaregistrovat [zkušební verzi na měsíc zdarma](https://azure.microsoft.com/free). 
...
1. Na webu [Azure Portal](https://portal.azure.com) klikněte na **Vytvořit prostředek** > **Compute** > **Windows Server 2016 Datacenter**.
...
1. Na webu [Azure Portal](https://portal.azure.com) klikněte na **Všechny služby**.
2. Do pole, které obsahuje slovo *Filtrovat*, zadejte *Skupiny prostředků*. Jakmile ve filtrovaném seznamu uvidíte položku **Skupiny prostředků**, klikněte na ni.
