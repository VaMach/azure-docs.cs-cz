---
title: "Vytvoření partnerského vztahu virtuálních sítí pomocí šablon Resource Manageru | Dokumentace Microsoftu"
...
---
# <a name="create-vnet-peering-using-resource-manager-templates"></a>Vytvoření partnerského vztahu virtuálních sítí pomocí šablon Resource Manageru
...
4. Pokud chcete nasadit soubor šablony, můžete spustit rutinu New-AzureRmResourceGroupDeployment, s jejíž pomocí lze vytvořit nebo aktualizovat nasazení. Další informace o použití šablon Resource Manageru najdete v tomto [článku](../resource-group-template-deploy.md).
   ...
   > [!NOTE]
   > Nahraďte odpovídajícím způsobem název skupiny prostředků a souboru šablony.
   > 
   > 
