...
Můžete si také přečíst informace o [konfigurace webhooky](../monitoring-and-diagnostics/insights-webhooks-alerts.md) a [aplikace logiky](../logic-apps/logic-apps-overview.md) pro vytvoření výstrahy.
