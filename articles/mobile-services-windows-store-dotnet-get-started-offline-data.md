...
<a href="/zh-cn/documentation/articles/mobile-services-windows-store-dotnet-get-started-offline-data" title="Windows Store C#" class="current">Windows Store C#</a>
...
<!-- URLs. -->
[Handling conflicts with offline support for Mobile Services]: /zh-cn/documentation/articles/mobile-services-windows-store-dotnet-handling-conflicts-offline-data/ 
