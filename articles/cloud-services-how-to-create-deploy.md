...
The Azure SDK provides tools for preparing these required deployment files. You can install the SDK from the [Azure Downloads](http://www.windowsazure.com/zh-cn/develop/downloads/) page, in the language in which you prefer to develop your application code.
...
1. In the [Management Portal](http://manage.windowsazure.cn/), click **New**, click **Cloud Service**, and then click **Quick Create**.
...
3. If you haven't installed the Azure SDK, click **Install Azure SD**K to open the [Azure Downloads page](http://www.windowsazure.com/zh-cn/develop/downloads/), and then download the SDK for the language in which you prefer to develop your code.
