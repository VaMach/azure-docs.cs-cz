<properties
   pageTitle="Azure ExpressRoute pro poskytovatele Cloud Solution Provider | Microsoft Azure"
...
# Azure ExpressRoute pro poskytovatele Cloud Solution Provider
...
>[AZURE.NOTE] V ExpressRoute se uplatňují omezení šířky pásma a počtu připojení, což znamená, že velké nebo složité implementace budou vyžadovat více okruhů ExpressRoute pro jednoho zákazníka.
...
## Správa prostředků Microsoft Azure
...
>[AZURE.NOTE] Pro ExpressRoute zákazník potřebuje vytvořit a spravovat okruh ExpressRoute.  
...
>[AZURE.NOTE] Šířku pásma sítě lze podle potřeby zvětšit bez přerušení komunikace, ovšem snížení rychlosti sítě vyžaduje zrušení okruhu a jeho opětné vytvoření s nižší rychlostí sítě.  
