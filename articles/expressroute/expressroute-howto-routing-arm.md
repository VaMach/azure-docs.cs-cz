<properties
   pageTitle="Postup konfigurace směrování pro okruh ExpressRoute | Microsoft Azure"
...
4. Nakonfigurujte soukromý partnerský vztah Azure pro okruh.
    ...
    >[AZURE.IMPORTANT] Ujistěte se, že své číslo AS zadáváte jako partnerské číslo ASN, ne zákaznické číslo ASN.
...
>[AZURE.WARNING] Před spuštěním této rutiny je nutné zajistit, že všechny virtuální sítě jsou od okruhu ExpressRoute odpojené. 
