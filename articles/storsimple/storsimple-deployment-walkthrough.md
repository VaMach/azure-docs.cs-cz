<properties
   pageTitle="Nasazení místního zařízení StorSimple | Microsoft Azure"
...
> [AZURE.IMPORTANT] Pokud již službu StorSimple Manager máte a chcete zařízení StorSimple následující nasadit s touto službou, tento krok přeskočte.
...
> [AZURE.IMPORTANT] Před provedením této konfigurace odpojte všechna síťová rozhraní kromě rozhraní DATA 0 v obou řadičích (aktivním i pasivním).
...
> [AZURE.NOTE] Pokud máte bránu konfigurovanou v jiném síťovém rozhraní než DATA 0, budete muset před instalací aktualizace zakázat síťová rozhraní DATA 2 a DATA 3. Přejděte do umístění **Devices > Configure** (Zařízení > Konfigurovat) a zakažte síťová rozhraní DATA 2 a DATA 3. Po dokončení aktualizace zařízení rozhraní opět povolte.
