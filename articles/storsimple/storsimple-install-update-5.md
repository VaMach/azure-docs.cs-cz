---
title: "Instalace portálu classic zařízení řady Update 5 StorSimple 8000 | Microsoft Docs"
description: "Popisuje postup instalace zařízení StorSimple 8000 řady aktualizací 5 na vašem zařízení řady StorSimple 8000 portálu classic."
services: storsimple
...
Tento kurz vysvětluje, jak nainstalovat aktualizace 5 na zařízení StorSimple se starší verzí softwaru prostřednictvím portálu Azure classic a metodou opravu hotfix. Metoda opravy hotfix se používá, když se pokoušíte nainstalovat aktualizace 5 na zařízení s verzemi před aktualizací 3. Metoda opravy hotfix je také použije, pokud brána je nakonfigurovaná na síťovém rozhraní než DATA 0 zařízení StorSimple a se pokoušíte aktualizovat z verze 1 před aktualizací softwaru.
...
> * Pokud používáte verzi před Update 3, důrazně doporučujeme nainstalovat aktualizace 5 prostřednictvím metody oprav hotfix. Abyste podporu vás provede aktualizaci, [protokolu lístek podpory](storsimple-8000-contact-microsoft-support.md).
> * Pokud používáte Update 3 a vyšší, doporučujeme nainstalovat software a další pravidelné aktualizace prostřednictvím portálu Azure classic. V závislosti na verzi, ze kterého je aktualizován, instalace aktualizací může trvat 4 hodiny (nebo vyšší) k instalaci. Aktualizace režimu údržby musí být nainstalován prostřednictvím rozhraní Windows PowerShell zařízení. Jako rušivý aktualizace jsou aktualizace režimu údržby, tyto vést k výpadkům pro vaše zařízení.
...
## <a name="install-update-5-via-the-azure-classic-portal"></a>Instalace aktualizací 5 prostřednictvím portálu Azure classic
...
> [!NOTE]
> Doporučené metody pro instalaci aktualizací 5 je prostřednictvím portálu Azure classic. Ale pokud používáte verzi před Update 3, důrazně doporučujeme, aby tuto metodu použijete k instalaci aktualizací 5. Tento postup byste měli použít také pokud selže kontrola brány při pokusu o instalaci aktualizací prostřednictvím portálu Azure classic. Kontrola selže, pokud máte bránu přiřazené 0 síťové rozhraní bez dat a zařízení používá verzi softwaru starší než Update 1.
