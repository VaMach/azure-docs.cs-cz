<properties 
   pageTitle="Virtuální zařízení StorSimple Update 2| Microsoft Azure"
...
#### Porovnání modelů virtuálního zařízení
...
| **Typ úložiště**          | Pro místní disky používá službu Azure Standard Storage<br></br> Zjistěte, jak [vytvořit účet služby Standard Storage]() | Pro místní disky používá službu Premium Storage<sup>2</sup> <br></br>Zjistěte, jak [vytvořit účet služby Premium Storage](storage-premium-storage.md#create-and-use-a-premium-storage-account-for-a-virtual-machine-data-disk)                                                               |
| **Zatížení**     | Načítání souborů ze zálohy na úrovni položek                                              | Scénáře vývoje a testování v cloudu, nízká latence, náročnější úlohy <br></br>Sekundární zařízení pro zotavení po havárii                                                                                            |
...
## Jak se liší virtuální zařízení od fyzického zařízení
...
#### Rozdíl oproti fyzickému zařízení
...
- Nastavte používání [účtu úložiště](storsimple-manage-storage-accounts.md#add-a-storage-account) ve stejné oblasti jako virtuální zařízení. Účty úložiště v jiných oblastech mohou vést k nižšímu výkonu. U virtuálního zařízení můžete použít účet služby Standard Storage nebo Premium Storage. Další informace o tom, jak vytvořit [účet služby Standard Storage]() nebo [účet služby Premium Storage](storage-premium-storage.md#create-and-use-a-premium-storage-account-for-a-virtual-machine-data-disk)
...
## Vytvoření a konfigurace virtuálního zařízení
...
### Krok 3 (nepovinný): Úprava konfiguračních nastavení zařízení
...
#### Konfigurace hesla Snapshot Manageru zařízení StorSimple
...
>[AZURE.NOTE] Pro virtuální zařízení je hostitelem systému Windows virtuální počítač Azure.
...
## Vzdálené připojení k virtuálnímu zařízení
...
### Krok 1: Konfigurace vzdálené správy
...
### Krok 2: Vzdálený přístup k virtuálnímu zařízení
...
>[AZURE.WARNING] **Pro zvýšení zabezpečení důrazně doporučujeme používat pro připojování ke koncovým bodům protokol HTTPS a po dokončení vzdálené relace prostředí PowerShell koncové body odstranit.**
...
## Přímé připojení k virtuálnímu zařízení
...
## Práce s virtuálním zařízením StorSimple
...
### Údržba virtuálního zařízení StorSimple
...
### Účty služby Storage pro virtuální zařízení
...
### Deaktivace virtuálního zařízení StorSimple
...
### Spuštění, zastavení a restartování virtuálního zařízení
...
### Obnovení na výchozí hodnoty z výroby
...
## Převzetí služeb při selhání virtuálního zařízení
...
## Vypnutí nebo odstranění virtuálního zařízení
