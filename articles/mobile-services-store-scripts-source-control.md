...
[Work with server scripts in Mobile Services]: /zh-cn/develop/mobile/how-to-guides/work-with-server-scripts
[JavaScript and HTML]: /zh-cn/develop/mobile/tutorials/get-started-with-users-js
[WindowsAzure.com]: http://www.windowsazure.com/
[Azure Management Portal]: https://manage.windowsazure.cn/
[Define a custom API that supports pull notifications]: /zh-cn/develop/mobile/tutorials/create-pull-notifications-dotnet
