...
> [WACOM.NOTE] The Web Sites portion of the Hybrid Connections feature is available only in the [Azure portal](https://manage.windowsazure.cn). To create a connection in BizTalk Services, see [Hybrid Connections](http://go.microsoft.com/fwlink/p/?LinkID=397274).

##Prerequisites
- An Azure subscription. For a free subscription, see [Azure Free Trial](http://www.windowsazure.cn/zh-cn/pricing/free-trial/).
...
## Create a Website in the Azure Portal ##

> [WACOM.NOTE] If you have already created a website in the Azure Portal that you want to use for this tutorial, you can skip ahead to [Create a Hybrid Connection and a BizTalk Service](#CreateHC) and start from there.
...
1. Back in the Portal, scroll down the blade for your website and choose **Hybrid connections**.
...
- For information on using a hybrid connection with a mobile service, see [Connect to an on-premises SQL Server from an Azure mobile service using Hybrid Connections](http://azure.microsoft.com/zh-cn/documentation/articles/mobile-services-dotnet-backend-hybrid-connections-get-started/).

###Additional Resources

[Hybrid Connections overview](http://azure.microsoft.com/zh-cn/documentation/articles/integration-hybrid-connection-overview/)

[Hybrid Connections web site](http://azure.microsoft.com/zh-cn/services/biztalk-services/)

[BizTalk Services: Dashboard, Monitor, Scale, Configure, and Hybrid Connection tabs](http://azure.microsoft.com/zh-cn/documentation/articles/biztalk-dashboard-monitor-scale-tabs/)
