...
## <a name="from-on-premise-to-the-cloud"></a>Z místního prostředí do cloudu
...
- **Minimální náklady a složitost nasazení.**  Protože jsou veškerá data a komponenty pro OMS uložené v Azure, můžete téměř okamžitě začít pracovat bez složitosti místních komponent a investice do nich.
...
To, že služby OMS běží v cloudu, neznamená, že nemohou efektivně spravovat místní prostředí.  Umístěte agenta na libovolný počítač s Windows nebo Linuxem v datovém centru, který bude odesílat data do Log Analytics, kde mohou být analyzovaná spolu s dalšími daty shromážděnými z cloudu nebo místních služeb.  Použijte Azure Backup a Azure Site Recovery k využití cloudu pro zálohování a vysokou dostupnost místních prostředků.  
