...
> [AZURE.IMPORTANT] Pokud Python 2.7 instalujete poprvé, je zapotřebí na obrazovce Customize Python 2.7.11 (Přizpůsobit Python 2.7.11) vybrat **Add python.exe to Path** (Přidat python.exe do proměnné PATH).
> 
