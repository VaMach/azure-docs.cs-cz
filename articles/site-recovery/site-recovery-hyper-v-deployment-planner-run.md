...
|-Currency|(Volitelné) Měna, ve které se ve vygenerované sestavě zobrazí náklady. Výchozí hodnota je americký dolar ($) nebo poslední použitá měna. K dispozici je seznam [podporovaných měn](site-recovery-hyper-v-deployment-planner-cost-estimation.md#supported-currencies).|
