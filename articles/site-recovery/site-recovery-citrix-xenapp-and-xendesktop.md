...
2. Ochrana a obnovení místního nasazení pomocí stolních počítačích operačního systému k poskytování klientských počítačů VDI pro klienta virtuálních ploch, včetně Windows 10, není podporována. Toto je, protože automatické obnovení systému nepodporuje obnovení počítače pomocí plochy OS'es.  Kromě toho některé virtuální plochy klientů příchutě (např. Windows 7) se ještě nepodporují pro licencování v Azure. [Další informace](https://azure.microsoft.com/pricing/licensing-faq/) týkající se licencování pro plochy klienta nebo serveru v Azure
