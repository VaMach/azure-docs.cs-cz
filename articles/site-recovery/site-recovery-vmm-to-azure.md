---
title: Replikace virtuálních počítačů Hyper-V v cloudech VMM do Azure přes Site Recovery pomocí webu Azure Portal | Microsoft Docs
...
> [!NOTE]
> Azure má dva různé [modely nasazení](../resource-manager-deployment-model.md) pro vytváření prostředků a práci s nimi: Azure Resource Manager a klasický model. Azure má také dva portály – portál Azure Clasic, který podporuje klasický model nasazení, a portál Azure s podporou pro oba modely nasazení.
> 
> 
...
7. V nastavení **Vlastnosti** > **Konfigurace vlastností** vyberte operační systém pro vybrané virtuální počítače a disk operačního systému. Pak klikněte na **OK**. Později můžete nastavit další vlastnosti.
