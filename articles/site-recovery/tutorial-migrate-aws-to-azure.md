...
1. V nabídce portálu [Azure Portal](https://portal.azure.com) klikněte na **Nový** -> **Úložiště** -> **Účet úložiště**.
...
1. Na portálu [Azure Portal](https://portal.azure.com) klikněte na **Nový** > **Sítě** >
    **Virtuální síť**.
...
1. Otevřete [Azure Portal](htts://portal.azure.com).
