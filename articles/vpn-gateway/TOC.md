...
## Rozhraní REST API
### [Referenční informace k rozhraní REST API (Resource Manager)](https://msdn.microsoft.com/library/mt163859)
### [Referenční informace k rozhraní REST API (Classic)](https://msdn.microsoft.com/library/jj154113)
