...
---
# <a name="configure-a-pointtosite-connection-to-a-vnet-using-the-classic-portal"></a>Konfigurace připojení typu Point-to-Site k virtuální síti prostřednictvím portálu Classic
