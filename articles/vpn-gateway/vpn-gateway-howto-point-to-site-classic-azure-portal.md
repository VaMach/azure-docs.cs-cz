<properties
   pageTitle="Konfigurace připojení brány VPN typu Point-to-Site ke službě Azure Virtual Network pomocí portálu Azure Portal | Microsoft Azure"
...
8. Vyberte **velikost** brány. Jde o hodnotu SKU, se kterou vytvoříte bránu virtuální sítě. Na portálu je výchozí SKU **Basic**. Další informace o SKU brány najdete v tématu [Informace o nastavení VPN Gateway](../articles/vpn-gateway/vpn-gateway-about-vpn-gateway-settings.md#gwsku).
