---
title: Brána BPN virtuální sítě – nejčastější dotazy | Microsoft Docs
...
### <a name="what-do-i-do-if-i-have-a-vpn-device-that-isn't-in-the-known-compatible-device-list?"></a>Jak postupovat, pokud mám zařízení VPN, které není v seznamu známých kompatibilních zařízení?
...
### <a name="does-azure-generate-the-same-ipsec/ike-pre-shared-key-for-all-my-vpn-connections-for-the-same-virtual-network?"></a>Generuje Azure stejný předsdílený klíč protokolu IPsec/IKE pro všechna připojení k síti VPN pro stejnou virtuální síť?
