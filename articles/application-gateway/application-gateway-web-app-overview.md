...
Zjistěte, jak nastavit službu Application Gateway s webovou aplikací jako členem fondu back-end, v tématu: [Konfigurace webových aplikací pomocí služby Application Gateway](application-gateway-web-app-powershell.md)
