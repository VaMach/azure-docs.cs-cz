...
---
title: Vytvoření služby Application Gateway pomocí šablon Azure Resource Manageru | Microsoft Docs
...
> [!NOTE]
> Tato nastavení jsou parametry této šablony. Pokud ji chcete přizpůsobit, můžete změnit pravidla, naslouchací proces a protokol SSL, který otevírá azuredeploy.json.
> 
> 
...
1. Prohlédněte si obsah v části **resources** a všimněte si následujících parametrů:
   ...
   * **name**. Název prostředku. Všimněte si volání **[parameters('applicationGatewayName')]**, které znamená, že název doplníte jako vstup nebo se doplní souborem parametru během nasazení.
...
2. Vraťte se na stránku [https://github.com/Azure/azure-quickstart-templates/blob/master/101-application-gateway-create/](https://github.com/Azure/azure-quickstart-templates/blob/master/101-application-gateway-create).
3. Klikněte na **azuredeploy-paremeters.json** a potom klikněte na **RAW**.
4. Uložte soubor do místní složky v počítači.
5. Otevřete soubor, který jste uložili, a upravte hodnoty parametrů. K nasazení služby Application Gateway popsané v tomto scénáři použijte následující hodnoty.
...
6. Uložte soubor. Šablonu JSON a šablonu parametrů můžete otestovat pomocí online ověřovacích nástrojů JSON, jako je třeba [JSlint.com](http://www.jslint.com/).
