...
Chcete-li provést kroky v tomto článku, je potřeba [nainstalovat rozhraní příkazového řádku Azure (Azure CLI) pro Mac, Linux a Windows](https://docs.microsoft.com/cli/azure/install-az-cli2).
