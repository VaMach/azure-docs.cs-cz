...
<p>This tutorial is based on the Mobile Services quickstart and builds on the previous tutorial <a href="/zh-cn/develop/mobile/tutorials/get-started-with-users-wp8">Get started with authentication</a>. Before you start this tutorial, you must first complete <a href="/zh-cn/develop/mobile/tutorials/get-started-with-users-wp8">Get started with authentication</a>.</p>
</div>
