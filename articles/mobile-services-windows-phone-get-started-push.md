...
This tutorial is based on the Mobile Services quickstart. Before you start this tutorial, you must first complete [Get started with Mobile Services]. 
   ...
   >[WACOM.NOTE]When you send more than 500 messages per user each day, you must instead use Notification Hubs. For more information, see <a href="/zh-cn/manage/services/notification-hubs/getting-started-windows-dotnet/">Get started with Notification Hubs</a>.
...
[Get started with Mobile Services]: /zh-cn/develop/mobile/tutorials/get-started-wp8
[Get started with data]: /zh-cn/develop/mobile/tutorials/get-started-with-data-wp8
[Get started with authentication]: /zh-cn/develop/mobile/tutorials/get-started-with-users-wp8
[Get started with push notifications]: /zh-cn/develop/mobile/tutorials/get-started-with-push-wp8
[Push notifications to app users]: /zh-cn/develop/mobile/tutorials/push-notifications-to-users-wp8
[Authorize users with scripts]: /zh-cn/develop/mobile/tutorials/authorize-users-in-scripts-wp8
...
[Get started with Notification Hubs]: /zh-cn/manage/services/notification-hubs/get-started-notification-hubs-wp8/
[What are Notification Hubs?]: /zh-cn/develop/net/how-to-guides/service-bus-notification-hubs/
[Send notifications to subscribers]: /zh-cn/manage/services/notification-hubs/breaking-news-wp8/
