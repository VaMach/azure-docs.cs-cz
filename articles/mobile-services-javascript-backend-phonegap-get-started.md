...
<!--<div class="dev-center-tutorial-subselector">
	<a href="/zh-cn/documentation/articles/mobile-services-dotnet-backend-phonegap-get-started/" title=".NET backend">.NET backend</a> | <a href="/zh-cn/documentation/articles/mobile-services-javascript-backend-phonegap-get-started/"  title="JavaScript backend" class="current">JavaScript backend</a>
</div>-->
...
<!-- URLs. -->
[Get started with data]: /zh-cn/documentation/articles/mobile-services-html-get-started-data
[Get started with authentication]: /zh-cn/documentation/articles/mobile-services-html-get-started-users
[Get started with push notifications]: /zh-cn/develop/mobile/tutorials/mobile-services-html-get-started-push
