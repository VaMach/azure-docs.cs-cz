...
> [!TIP]
> Nezapomeňte zadat plně kvalifikovaný název registru (malými písmeny). V tomto příkladu je to `myregistry-contoso.azurecr.io`.
...
Následující příkaz spustí místní kontejner Nginx v interaktivním režimu (abyste viděli výstup serveru Nginx), který bude naslouchat na portu 8080. Jakmile se příkaz zastaví, odebere spuštěný kontejner.
