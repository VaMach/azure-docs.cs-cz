...
Uživatelé teď můžou používat zdroje nasazení, pro věcí [průběžné nasazování](https://docs.microsoft.com/en-us/azure/app-service-web/app-service-continuous-deployment), [místní nasazení Git](https://docs.microsoft.com/en-us/azure/app-service-web/app-service-deploy-local-git), a [cloudu složky synchronizační](https://docs.microsoft.com/en-us/azure/app-service-web/app-service-deploy-content-sync).
