...
| **Key Vault** | EBF13B9F-B3EA-46FE-BF54-396E93D48AB4 |Transakce Key Vault | Počet požadavků v 10,000s| Počet přijatých Key Vault datové roviny požadavky REST API |
