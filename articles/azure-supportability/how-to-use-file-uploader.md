...
| .bat        | .dtsx | .log        | soubory .pdf  | RPT     | .uccapilog | .XMLA   |
| .blg        | .EDS  | LPK        | .piz  | .RTE     | .uccplog   | XPS    |
| .CA_        | .EMF  | manifest   | .pmls | .RTF     | udcx      | XSD    |
| . SOUBOR CAB        | EML  | .master     | soubor ve formátu PNG  | .Run     | .vb_       | XSN    |
...
| Sada        | .ex_  | .msi        | PST  |  -        | WMV.       | ZIP    |
| .cs         | .ex0  | .Mso        | .pub  | -         | WMZ       | .zip_   |
| . SDÍLENÝ SVAZEK CLUSTERU        | . FRD  | .msu        | -      |-          | WPS       | .zipp   |
