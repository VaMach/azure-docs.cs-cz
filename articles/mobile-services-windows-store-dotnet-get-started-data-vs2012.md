...
1.  Download the C\# version of the GetStartedWithData sample app from the [Developer Code Samples site][GetStartedWithData app].
...
<!-- Anchors. --> <!-- Images. --> <!-- URLs. -->
  ...
  [watch the tutorial]: http://channel9.msdn.com/Series/Windows-Azure-Mobile-Services/Windows-Store-app-Getting-Started-with-Data-Connecting-your-app-to-Windows-Azure-Mobile-Services
  [Get started with data in Mobile Services]: /en-us/develop/mobile/tutorials/get-started-with-data-dotnet/
