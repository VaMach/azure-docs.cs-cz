...
Místní server (Windows klienta nebo serveru Windows Server nebo Data Protection Manager) musí být k ověření pomocí úložiště záloh předtím, než můžete zálohovat data do Azure. Ověřování je dosaženo pomocí "přihlašovací údaje trezoru". Koncept přihlašovací údaje trezoru je podobný koncept "publikovat nastavení" souboru, který se používá v prostředí Azure PowerShell.
...
2. Klikněte na **služeb zotavení** v levém navigačním podokně a vyberte úložiště záloh, které jste vytvořili. Klikněte na ikonu cloudu můžete získat rychlý Start zobrazení úložiště záloh.
