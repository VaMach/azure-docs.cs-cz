...
* **Koncepce**: celkový přehled součástí tvořících každou bránu, kterou vytvoříte pomocí sady IoT Gateway SDK.  
...
## <a name="azure-iot-gateway-sdk-concepts"></a>Koncepce sady Azure IoT Gateway SDK
Než si projdete ukázkový kód nebo než vytvoříte pomocí sady SDK svou vlastní bránu, měli byste porozumět klíčovým koncepcím, které jsou základem architektury sady IoT Gateway SDK.
...
![Abstraktní vrstva sady Azure IoT Gateway SDK][2]
