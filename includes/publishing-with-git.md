...
> [chinacloudsites.cn] Many of the Git commands described in this article are performed automatically when creating a Web Site using the <a href="/en-us/develop/nodejs/how-to-guides/command-line-tools/">Azure Command-Line Tools for Mac and Linux</a>.
...
[Azure Developer Center]: http://www.windowsazure.cn/zh-cn/documentation/
[Azure portal]: http://manage.windowsazure.cn
[Git website]: http://git-scm.com
[Installing Git]: http://git-scm.com/book/en/Getting-Started-Installing-Git
[How to use PowerShell for Azure]: http://www.windowsazure.cn/zh-cn/develop/nodejs/how-to-guides/powershell-cmdlets/
...
[Continuous delivery to Azure using Visual Studio Online]: http://azure.microsoft.com/zh-cn/documentation/articles/cloud-services-continuous-delivery-use-vso/
