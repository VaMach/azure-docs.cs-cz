...
Modul runtime v následujícím příkazu je nastaven na `PHP|7.0`. Pokud chcete zobrazit všechny podporované moduly runtime, spusťte [az webapp seznamu runtimes](/cli/azure/webapp#list-runtimes). 
