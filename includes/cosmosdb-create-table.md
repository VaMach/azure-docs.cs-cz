...
1. Na webu Azure Portal v navigační nabídce v části **Tabulky** klikněte na **Průzkumník dat**. 
2. V okně Průzkumníka dat klikněte na **Nová kolekce** a potom stránku vyplňte pomocí následujících informací.
    ...
    ID kolekce|sample-table|ID nové kolekce. Názvy kolekcí mají stejné požadavky na znaky jako ID databází.
    ...
    Klíč oddílu|/lastname|Klíč oddílu, který bude rovnoměrně distribuovat data do jednotlivých oddílů. Výběr správného klíče oddílu je důležitý pro vytvoření výkonné kolekce. Další informace se dozvíte v tématu [Návrh a vytváření oddílů](../articles/cosmos-db/partition-data.md#designing-for-partitioning).
