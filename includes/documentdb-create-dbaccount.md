...
3. V okně **Nový účet** zadejte požadovanou konfiguraci účtu databáze Azure Cosmos. 
    ...
    Rozhraní API|SQL (DocumentDB)|Dál v tomto článku budeme programovat za použití [rozhraní API DocumentDB](../articles/documentdb/documentdb-introduction.md).|
