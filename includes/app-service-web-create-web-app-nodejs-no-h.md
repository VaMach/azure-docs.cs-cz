...
Modul runtime v následujícím příkazu je nastaven na `NODE|6.9`. Pokud chcete zobrazit všechny podporované moduly runtime, spusťte [az webapp seznamu runtimes](/cli/azure/webapp#list-runtimes). 
