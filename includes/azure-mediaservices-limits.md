...
<sup>7</sup>Pokud nahráváte obsah pro prostředek služby Azure Media Services s cílem zpracovat ho pomocí některého z procesorů médií v naší službě (tj. kodérů jako Media Encoder Standard a Media Encoder Premium Workflow nebo analytických modulů, jako je Face Detector), měli byste brát v úvahu následující omezení. 

| Typ rezervovaných jednotek médií | Maximální velikost souboru (GB)| 
| --- | --- | 
|S1    | 325|
|S2    | 640|
|S3    | 260|
