...
> [!NOTE]
> Pokud nemáte účet Azure, budete potřebovat. Zde si můžete zaregistrovat [bezplatnou zkušební verzi](../articles/active-directory/sign-up-organization.md). Kromě toho se podle nich zorientujete úplně je potřeba mít buď [jq](https://stedolan.github.io/jq/) nebo některých jiných JSON analýza nástroj nebo knihovny nainstalované.
> 
> 
