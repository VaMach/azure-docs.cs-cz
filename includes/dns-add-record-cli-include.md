#### <a name="create-an-a-record-set-with-single-record"></a>Vytvoření sady záznamů A s jedním záznamem
...
#### <a name="create-a-txt-record-set-with-single-record"></a>Vytvoření sady záznamů TXT s jedním záznamem
