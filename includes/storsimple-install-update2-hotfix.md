...
3. Do vyhledávacího pole katalogu služby Microsoft Update, zadejte číslo znalostní báze Knowledge Base (KB) opravy hotfix, které chcete stáhnout, například **3121901**a potom klikněte na **vyhledávání**.
   
    Zobrazí se seznam oprav hotfix, například **kumulativní softwaru sady aktualizací 2.0 pro zařízení StorSimple řady 8000**.
...
5. Vyhledejte všechny další opravy hotfix uvedené v předchozí tabulce (**3121900**, **3080728**, **3090322**, a **3121899**) a přidejte všechny nákupní košík.
...
6. Po dokončení aktualizace softwaru, opakujte kroky 3 až 5 k instalaci a sledování SaaS agenta a agenta služby MDS. Ujistěte se, že `all-hcsmdssoftwareupdate_0b438ddf0d5b686aada2378b754fac8c7f2160e9.exe` nainstalovali před `all-cismdsagentupdatebundle_f98e62f4d56c79e2a6644d027af7a2393a93827a.exe`.
7. Ověření verze softwaru systému. Zadejte:
...
8. Opakujte kroky 3 až 5 pro instalaci zbývající oprav hotfix regular režimu.
