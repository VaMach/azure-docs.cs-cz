...
> [!IMPORTANT]
> V tomto kurzu se předpokládá použití sady Visual Studio 15. Můžete použít rovněž Visual Studio 13, jehož uživatelské rozhraní je ale mírně odlišné od uživatelského rozhraní v tomto kurzu.
> 
> 
