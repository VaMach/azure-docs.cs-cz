## <a name="about-records"></a>Informace o záznamech
...
## <a name="about-record-sets"></a>Informace o sadách záznamů
...
#### <a name="wildcard-record-sets"></a>Sady záznamů se zástupným znakem
