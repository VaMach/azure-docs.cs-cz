...
| --- | --- | --- |
| [Přidání funkcí registrace a přihlášení do aplikace pro iOS](active-directory-b2c-devquickstarts-ios.md) |[Přidání funkcí registrace a přihlášení do aplikace .NET MVC](../articles/active-directory-b2c/active-directory-b2c-devquickstarts-web-dotnet.md) |[Registrace aplikace](../articles/active-directory-b2c/active-directory-b2c-app-registration.md) |
