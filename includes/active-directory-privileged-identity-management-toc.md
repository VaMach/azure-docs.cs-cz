...
- [Jak udělit jiným uživatelům přístup pro správu ke službě Privileged Identity Management](../articles/active-directory/active-directory-privileged-identity-management-how-to-give-access-to-pim.md)
...
- [Zahájení kontroly přístupu](../articles/active-directory/active-directory-privileged-identity-management-how-to-start-security-review.md)
- [Provádění kontroly přístupu](../articles/active-directory/active-directory-privileged-identity-management-how-to-perform-security-review.md)
- [Dokončení kontroly přístupu](../articles/active-directory/active-directory-privileged-identity-management-how-to-complete-review.md)
