...
> [!NOTE]
> Pokud při nasazování předkonfigurovaného řešení narazíte na problémy, podívejte se na článek [Oprávnění na webu azureiotsuite.com][lnk-permissions] a do sekce [nejčastějších dotazů][lnk-faq]. Pokud problémy přetrvávají, vytvořte na [portálu][lnk-portal] lístek služby.
> 
> 
